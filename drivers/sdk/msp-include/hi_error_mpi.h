...
/**
\file
\brief Describes the information about common error codes. CNcomment: �ṩ����������������Ϣ
*/
/* add include here */
...
#define	 HI_ERR_KLAD_ALREADY_SET_ATTR		    (HI_S32)(0x804E0089)
#define	 HI_ERR_KLAD_KEY_NOT_READY		    (HI_S32)(0x804E008a)
#define	 HI_ERR_KLAD_NOT_SUPPORT		    (HI_S32)(0x804E008b)
#define	 HI_ERR_KLAD_RELEASE_ERR		    (HI_S32)(0x804E008c)
#define	 HI_ERR_KLAD_OPEN_ERR			    (HI_S32)(0x804E008d)
