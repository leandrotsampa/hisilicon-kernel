...
typedef struct tagEDID_BASE_PARA_S					/* Basic Display Parameters */
{
    ...
    EDID_COLO_DEPTH_E		 enColorDepth;	   /* ֧�ֵ���ɫBIT EDID 1.4 Add*/
    EDID_COLO_ENCODING_E	 enColorEncoding;  /* ֧�ֵ���ɫ���뷽ʽ EDID 1.4 Add*/
