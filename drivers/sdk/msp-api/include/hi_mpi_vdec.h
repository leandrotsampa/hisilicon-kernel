...
{
    HI_U8* pu8UsrVirAddr[MAX_VDEC_EXT_BUF_NUM];	 /**<User virtual address *//**<CNcomment: �û�̬�����ַ*/
    HI_U32 u32PhyAddr[MAX_VDEC_EXT_BUF_NUM];	 /**<Physical address *//**<CNcomment: ������ַ*/
    HI_U8* pu8UsrVirAddr_meta[MAX_VDEC_EXT_BUF_NUM];  /**<User virtual address *//**<CNcomment: �û�̬�����ַ*/
    HI_U32 u32PhyAddr_meta[MAX_VDEC_EXT_BUF_NUM];     /**<Physical address *//**<CNcomment: ������ַ*/
...
{
    HI_U64 u64UsrVirAddr[MAX_VDEC_EXT_BUF_NUM];	 /**<User virtual address *//**<CNcomment: �û�̬�����ַ*/
    HI_U32 u32PhyAddr[MAX_VDEC_EXT_BUF_NUM];	 /**<Physical address *//**<CNcomment: ������ַ*/
    HI_U64 u64UsrVirAddr_meta[MAX_VDEC_EXT_BUF_NUM];  /**<User virtual address *//**<CNcomment: �û�̬�����ַ*/
    HI_U32 u32PhyAddr_meta[MAX_VDEC_EXT_BUF_NUM];     /**<Physical address *//**<CNcomment: ������ַ*/
...
typedef enum hiVDEC_FRAMEBUFFER_MODE_E{
	VDEC_BUF_VPSS_ALLOC_MANAGE = 0,/**vpss buffer should alloc and manage by vpss*//**<CNcomment:vpss��buffer�ķ���͹�����vpssģ���Լ�����*/
    VDEC_BUF_USER_ALLOC_MANAGE,	   /**vpss buffer should alloc and manage by user*//**<CNcomment:vpss��buffer������vdec���ϲ��û������䣬������vdec����*/
    VDEC_BUF_TYPE_BUTT
}VDEC_FRAMEBUFFER_MODE_E;
typedef enum hiVDEC_FRAMEBUFFER_STATE_E{
	VDEC_BUF_STATE_EMPTY = 0,/**the frame buffer have no data*//**<CNcomment:Ҫ��ѯ��buffer����û������*/
    VDEC_BUF_STATE_FULL,     /**the frame buffer have data*//**<CNcomment:Ҫ��ѯ��buffer�����Ѿ����������Ч����*/
    VDEC_BUF_STATE_IN_USE,   /**the frame buffer is in using*//**<CNcomment:Ҫ��ѯ��buffer���ڱ�������ݵĹ�����*/
    VDEC_BUF_STATE_BUTT
...
{
    HI_VDEC_HDR_CHAN_TYPE_BL = 0,    /**<CNcomment: VDEC BL����ͨ��.*/
    HI_VDEC_HDR_CHAN_TYPE_EL,	     /**<CNcomment: VDEC EL����ͨ��.*/
    HI_VDEC_HDR_CHAN_TYPE_BUTT
} VDEC_HDR_CHAN_TYPE_E;

typedef struct hiVDEC_HDR_ATTR_S
{
    VDEC_HDR_CHAN_TYPE_E       enVdecHDRType;	 /**<CNcomment: VDEC����ͨ������.*/
    HI_UNF_AVPLAY_HDR_ATTR_S   AvplayHDRAttr;	 /**<CNcomment: HDR��������.*/
} VDEC_HDR_ATTR_S;
