...
{
    HI_DRV_DISP_WORKING_MODE_SDR = 0,		 /* ����ԴΪSDRԴʱ������ù���ģʽ */
    HI_DRV_DISP_WORKING_MODE_DOLBY_HDR,		 /* ����ԴΪDolbyԴʱ������ù���ģʽ */
    HI_DRV_DISP_WORKING_MODE_LAST_GRAPHIC_DOLBY, /* û����Ƶ�㣬��DolbyVision���ģʽ�����һ֡DolbyVisionͼ�������
						    ��ģʽ���ڵ�ԭ�������˳�DolbyVision���ģʽʱ ��source��Ҫ�������һ֡���*/
    HI_DRV_DISP_WORKING_MODE_DOLBY_HDR10,	 /* ����ԴΪHDR10����DOLBY HDRͨ·�����Ĺ���ģʽ */
    HI_DRV_DISP_WORKING_MODE_HISI_HDR,		 /* ����ԴΪHDR����Hisi HDRͨ·�����Ĺ���ģʽ */
...
{
    HI_DRV_DOLBY_COMPOSER_MODE_FULL = 0,    /* BL��EL����composerģʽ */
    HI_DRV_DOLBY_COMPOSER_MODE_EL_FREE,	    /* ����EL��BL����composerģʽ */
...
}HI_DRV_DISP_PLAY_INFO_S;//���汾��HDR���������Ϣ������/����ģʽ�����Լ�����ͼ�β�ʱ��Ҫ��Щ��Ϣ
