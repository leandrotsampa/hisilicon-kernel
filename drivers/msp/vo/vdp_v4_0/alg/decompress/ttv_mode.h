...
typedef struct
{
	int org_frm_width;	//ͼ�����(Y��UV������ͬ)
	int org_frm_height;	//ͼ��߶�(Y��UV������ͬ)
	int raw;			//��֡�Ƿ�ʹ��ѹ����0���ǣ�1����
	int bit_depth;		//ͼ��λ���
	int is_simple_vlc;	//�̶���1
	int dec_sum_bit;
	int is_segment_raw;	//��segment�Ƿ�ʹ��ѹ����0���ǣ�1����
	int *raw_segment_list;	//��֡��raw�б���ָʾ����seg�Ƿ�ѹ����0���ǣ�1����
