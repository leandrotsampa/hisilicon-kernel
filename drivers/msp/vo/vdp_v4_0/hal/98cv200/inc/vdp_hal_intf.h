...
{
    CBB_FROST_CLOSE = 0x0 ,	  /**<Close  */ /**<CNcomment:�ر� CNend*/
    CBB_FROST_LOW	  ,	  /**<Low    */ /**<CNcomment:��   CNend*/
    CBB_FROST_MIDDLE	  ,	  /**<Middle */ /**<CNcomment:��   CNend*/
    CBB_FROST_HIGH	  ,	  /**<High   */ /**<CNcomment:ǿ   CNend*/
...
{
	//CBB_DISPLAY_INFO_S	stDispInfo[HI_DRV_DISPLAY_BUTT]; /*ÿ����ʾͨ������Ϣ */
	CBB_DISPLAY_INFO_S	stDispInfo[2]; /*ÿ����ʾͨ������Ϣ */
} CBB_DISP_INFO_S;
...
typedef struct hiPQ_VDP_ALG_WBC_INFO_S
{
    ...
    HI_VOID *pstVdpWbcRegCpuAddr;	 /* ifmd��Globlal Motion and DB�Ļ�д��Ϣ */
	HI_U32	 u32VdpWbcRegPhyAddr;	     /* ifmd��Globlal Motion and DB�Ļ�д��Ϣ */
	HI_BOOL bSecure;
	HI_BOOL bSmmu ;
...
typedef struct tagCBB_LAYER_CFG_INFO_S
{
 ...
 #if 0
	HI_NONLINEAR_CFG_S	stNonLinear		    ;/*���ô�0*/
	HI_DRV_SYS_INFO_S	stSysInfo				    ; /*������ʾ��Ϣ��*/
 #endif
