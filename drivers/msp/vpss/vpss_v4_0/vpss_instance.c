...
#define HI_VPSS_MAX_BUFFER_NUMB	6
...
HI_VOID VPSS_INST_RevisePortOutRect(VPSS_INSTANCE_S *pstInstance)
{
	...
	if (pstPort->s32PortId != VPSS_INVALID_HANDLE)
	{
		...
		else if ((s32OutRectH == 0) && (pstStreamInfo->u32StreamH > 1920))
		{
		    pstPort->s32OutputHeight  = 1920;
		    pstPort->s32OutputWidth = pstStreamInfo->u32StreamW * 1920 / pstStreamInfo->u32StreamH;
		}
