...
HI_U32 VPSS_CTRL_Zme2lAndRotateCfg(VPSS_IP_E enIp, VPSS_TASK_S *pstTask)
{
    ...
    if (  0 != u32DstW && 0 != u32DstH) //ֻ����һ�λ���֡��

    {
	if (HI_NULL == pstTask->pstFrmNodeZME1L) //ֻ����һ�λ���֡��
	{
