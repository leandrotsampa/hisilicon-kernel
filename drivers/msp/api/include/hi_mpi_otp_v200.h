...
HI_S32 HI_MPI_OTP_GetRootKey(HI_UNF_OTP_ROOTKEY_E type, HI_U8 *key, HI_U32 *len);
HI_S32 HI_MPI_OTP_BurnProductPV(HI_UNF_OTP_BURN_PV_ITEM_S *pv, HI_U32 u32Num);
HI_S32 HI_MPI_OTP_DebugProductPV(HI_UNF_OTP_BURN_PV_ITEM_S *pv, HI_U32 u32Num);
