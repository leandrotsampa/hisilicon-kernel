...
/*****************************************************************************/
   ...
   extern "C" {
    ...
    #define JPGD_HDEC_STREAM_BUFFER_COUNT            2
#endif
...
#else
         HI_U8    SavaStreambufIndex;
         HI_U32   u32SaveStreamPhyBuf[JPGD_HDEC_STREAM_BUFFER_COUNT];
         HI_CHAR* pSaveStreamVirBuf[JPGD_HDEC_STREAM_BUFFER_COUNT];
#endif
