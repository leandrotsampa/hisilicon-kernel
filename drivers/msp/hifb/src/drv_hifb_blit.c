...
* description	: CNcomment: �ж�TDE�Ƿ�֧�ָ����ظ�ʽ���� CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
* description	: CNcomment:FB���ظ�ʽת��TDE���ظ�ʽ CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
static HI_S32 HIFB_DRV_QuickCopyEx(HIFB_BUFFER_S *pSrcImg, HIFB_BUFFER_S *pDstImg)
{
    ...
    if (s32Ret != HI_SUCCESS)
    {
	HIFB_ERROR("quick copyex logo to app failure\n");
	Gfx2dExportFuncs->pfnTdeCancelJob(handle);
	return s32Ret;
    }
...
static HI_S32 HIFB_DRV_Blit(HIFB_BUFFER_S *pSrcImg, HIFB_BUFFER_S *pDstImg,  HIFB_BLIT_OPT_S *pstOpt, HI_BOOL bRefreshScreen)
{
    ...
    if (pstOpt->bCallBack){
     /**
      **Ҫ��TDE������ɣ�tde�ڲ������pstOpt->pfnCallBack��������������fbע�����
      **/
...
* description	: CNcomment: ����TDE�ص����� CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
* description	: CNcomment:��surface CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
