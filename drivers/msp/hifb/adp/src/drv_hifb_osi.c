...
* description	: CNcomment: ����ͼ��ID��ȡGP ID CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
* description	: CNcomment: ����ͼ��color key CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
* description	 : CNcomment: ����ͼ���м�� CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	 : NA
***************************************************************************************/
...
* description	 : CNcomment: ����ͼ�����ظ�ʽ CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	 : NA
***************************************************************************************/
...
* description	: CNcomment: ����ͼ�㿹�� CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
* description	: CNcomment: ����ͼ��alpha��ֵ CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
* description	: CNcomment: ��ȡGPȫ��alphaֵΪ0�����ص���� CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
{
    g_stGfxOps.HIFB_ADP_SetInOutScanLine(LayerId, HI_TRUE);
}

HI_VOID HIFB_DRV_SetOutVoCallBackScanLine(HIFB_LAYER_ID_E LayerId)
{
    g_stGfxOps.HIFB_ADP_SetInOutScanLine(LayerId, HI_FALSE);
}
...
{
    g_stGfxOps.OPTM_GfxGetClosePreMultState(OPTM_GetGfxGpId(enLayerId), pbShouldClosePreMult);
}


HI_VOID HIFB_DRV_WhetherDiscardFrame(HIFB_LAYER_ID_E enLayerId, HI_BOOL *pNoDiscardFrame)
{
    g_stGfxOps.OPTM_GfxWhetherDiscardFrame(enLayerId, pNoDiscardFrame);
}
...
* description	: CNcomment: �򿪶�Ӧ��ͼ�� CNend\n
* param[in]	: HI_VOID
* retval	: NA
* others:	: NA
***************************************************************************************/
...
HI_VOID DRV_HIFB_GetAdpCallBackFunction(HIFB_DRV_OPS_S *AdpCallBackFunction)
{
    ...
    AdpCallBackFunction->HIFB_DRV_SetInVoCallBackScanLine  = HIFB_DRV_SetInVoCallBackScanLine;
    AdpCallBackFunction->HIFB_DRV_SetOutVoCallBackScanLine = HIFB_DRV_SetOutVoCallBackScanLine;
    ...
    AdpCallBackFunction->HIFB_DRV_GetClosePreMultState = HIFB_DRV_GetClosePreMultState;
    AdpCallBackFunction->HIFB_DRV_WhetherDiscardFrame  = HIFB_DRV_WhetherDiscardFrame;
