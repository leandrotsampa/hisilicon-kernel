...
static HI_PQ_WBC_POINT_SEL_E PQ_HAL_WbcVpWriteBackPointConfig(HI_PQ_WBC_STRATEGY_IN_S stZmeIn)
{
    ...
    ***/
    ...
    {
	/* Add 20160325 d00241380 ��ָ�곡��, ����Դ��CVBS�ķֱ���һ��ҲҪ��V0��д
...
static HI_S32 PQ_HAL_GetWbcVpZmeStrategy (HI_PQ_WBC_STRATEGY_IN_S stZmeIn, HI_PQ_WBC_VP_STRATEGY_OUT_S *pstZmeOut)
{
    ...
    pstZmeOut->stZme.bOutFmt = PQ_HAL_WbcVpZmeOutFrameOrField(stZmeIn);
