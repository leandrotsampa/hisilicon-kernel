...
/*ÿ128bitһ��,ÿ10bit���һ��ϵ��.ÿ128bit���12��ϵ��*/
...
/*�˲�ϵ�����ڴ��еĴ洢��ʽ:Ӳ���ṩ�������˲�ϵ����ַ�Ĵ���:
ˮƽ�˲�ϵ����ַ,��ֱ�˲�ϵ����ַ.
ˮƽ�����˲�ϵ����ˮƽɫ���˲�ϵ�������һ��,������ǰ,ɫ���ں�.ͬ��,��ֱ����
�˲�ϵ���ʹ�ֱɫ���˲�ϵ������һ��,������ǰ,ɫ���ں�*/
/*ÿ�����űȶ�Ӧ���˲�ϵ����Ҫ�Ĵ洢�ռ��С,��λΪ�ֽ�*/
/*�洢��ʽ:ÿ12��ϵ��һ��,ÿ��16���ֽ�*/
...
static HI_S32 InitFilterParam(HI_VOID);/*�����˲�ϵ��*/
static HI_VOID DeinitFilterParam(HI_VOID);
static inline HI_VOID InitCrgReg(HI_VOID);/*��ʼ��crg�Ĵ���*/
static inline HI_VOID DeinitCrgReg(HI_VOID);/*ȥ��ʼ��crg�Ĵ���*/
static inline HI_S32 InitDevReg(HI_VOID);/*��ʼ���豸�Ĵ���*/
static inline HI_VOID DeinitDevReg(HI_VOID);/*ȥ��ʼ���豸�Ĵ���*/
static HI_S32 CheckCompose(const HI_GFX2D_DEV_ID_E enDevId,
			   HI_GFX2D_COMPOSE_LIST_S *pstComposeList,
			   HI_GFX2D_SURFACE_S *pstDstSurface);/*compose�������*/
static inline HI_VOID InitNode(HWC_NODE_S* pstNode); /*��ʼ������ڵ�*/
...
static inline HI_VOID SetInCsc(HWC_NODE_S *pstNode);/*��������CSC*/
static inline HI_VOID SetOutCsc(HWC_NODE_S* pstNode);/*�������CSC*/
...
static inline HI_VOID SetZme(HWC_NODE_S* pstNode, HI_GFX2D_COMPOSE_S *pstCompose, HWC_LAYER_ID enLayerId)
{
    ...
    /*���Ź���:
    1.��Ƶ���ʽ(plannar,semi-plannar,package 422)���ſ��ر����.��
    ��֧��(����ֱ���>1920 && ����ֱ���>960)
    2.ͼ�β��ʽ���ſ��ؿɸ�����Ҫ�򿪻��߹ر�.��֧��
    (����ֱ���>1920 && ����ֱ���> 1920)*/
    ...
    /*���ڵ���16������ʱ��ѡ������ǰ����n��1,n�����ű���ȷ��;����n��1ʱ����Ӱ��ͼ��
    ����:����Ӳ��Լ�����Ҳ���ܻᶪ��*/
    /*������ʽʱ��(����ֱ���>1920 && ����ֱ���>960)���Ƚ���ˮƽ���*/
    /*ͼ�θ�ʽʱ��(����ֱ���>1920 && ����ֱ���>1920)���Ƚ���ˮƽ���*/
