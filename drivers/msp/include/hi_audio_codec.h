...
typedef enum hiHA_CODEC_ID_E
{
    ...
    HA_AUDIO_ID_CUSTOM_2        = HA_BUILD_CODEC_ID(VENDOR_HISI, FORMAT_MULTI, 0x0402),//zhaobaoren
    HA_AUDIO_ID_CUSTOM_3        = HA_BUILD_CODEC_ID(VENDOR_HISI, FORMAT_MULTI, 0x0403),
    HA_AUDIO_ID_CUSTOM_4        = HA_BUILD_CODEC_ID(VENDOR_HISI, FORMAT_MULTI, 0x0404),
} HA_CODEC_ID_E;
