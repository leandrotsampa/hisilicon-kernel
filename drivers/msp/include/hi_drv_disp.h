...
{
    HI_DRV_DISP_OUT_TYPE_E	       enDispType;	   /* ��ʾ���� */
    union
    {
	HI_HDMI_DOLBY_SINK_CAPS_S      stDolbySinkAttr;	   /* Dolby�������ԣ��� enDispType = HI_DRV_DISP_TYPE_DOLBY ʱ��Ч */
	HI_HDMI_HDR_SINK_CAPS_S	       stHDR10SinkAttr;	   /* ��׼HDR�������ԣ��� enDispType = HI_DRV_DISP_TYPE_HDR10 ʱ��Ч */
    } unSinkAttr;
...
typedef struct hiDISP_DISPLAY_INFO_S
{
    ...
    HI_U32 u32Kg;
    HI_U32 u32Kb;
    HI_DRV_DISP_HDR_ATTR_S    stDispHDRAttr;  /*  HDR��ʾ������� */
