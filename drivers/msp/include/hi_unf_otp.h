...
#define __OTP_VERSION_OLD__ 1
#define __OTP_VERSION_NEW__ 1
...
#define OTP_FIELD_VALUE_MAX_LEN 512
...
/**
\brief Read root key, HI_UNF_OTP_OEM_ROOTKEY/HI_UNF_OTP_STB_ROOTKEY are allowed. CNcomment:读取根密钥，允许读HI_UNF_OTP_OEM_ROOTKEY/HI_UNF_OTP_STB_ROOTKEY CNend
\attention \n
N/A
\param[in] enRootkeyType: Type of rootkey.          CNcomment:根密钥类型 CNend
\param[out] pu8Rootkey: Point to root key value.    CNcomment:指针类型，根密钥 CNend
\param[out] u32Len: The length of root key.         CNcomment:根密钥长度 CNend
\retval ::HI_SUCCESS Success CNcomment:HI_SUCCESS 成功 CNend
\retval ::HI_FAILURE This API fails to be called CNcomment:HI_FAILURE  API系统调用失败 CNend
\retval ::HI_ERR_CA_NOT_INIT The advanced CA module is not initialized CNcomment:HI_ERR_CA_NOT_INIT  CA未初始化 CNend
\retval ::HI_ERR_CA_INVALID_PARA The input parameter value is invalid CNcomment:HI_ERR_CA_INVALID_PARA  输入参数非法 CNend
...
N/A
*/
HI_S32 HI_UNF_OTP_GetRootKey(HI_UNF_OTP_ROOTKEY_E enRootkeyType, HI_U8 *pu8Rootkey, HI_U32 *u32Len);
...
/**
\brief Debug product PV. CNcomment:调试校验PV数据的正确性 CNend
\attention \n
N/A
\param[in] pstPV: Point to the name of the config table.   CNcomment:指针类型，配置数据表地址 CNend
\param[in] u32Num:  the nember of config table.         CNcomment:配置数据条目数 CNend
...
N/A
*/
HI_S32 HI_UNF_OTP_DebugPV(HI_UNF_OTP_BURN_PV_ITEM_S *pstPV, HI_U32 u32Num);
