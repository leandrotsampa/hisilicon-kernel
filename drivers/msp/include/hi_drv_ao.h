...
typedef struct
{
    ...
    HI_VIRT_ADDR_T  tPcmBuffer;		/**<Pointer to the buffer for storing the pulse code modulation (PCM) data*/ /**<CNcomment: PCM���ݻ���ָ��*/
    HI_VIRT_ADDR_T  tBitsBuffer;	/**<Pointer to the buffer for storing the stream data*/ /**<CNcomment: �������ݻ���ָ��*/
    ...
    HI_U32  u32IECDataType;	   /**<IEC61937 Data Type*/ /**<CNcomment: IEC61937�������ͱ�ʶ����8bitΪIEC�������� */
} AO_FRAMEINFO_S;
...
typedef struct
{
    ...
    DRV_SND_OUTPORT_S	    stOutport[HI_UNF_SND_OUTPUTPORT_MAX];  /**<Outports attached sound*/ /**<CNcomment:�󶨵�Sound�豸������˿�*/
