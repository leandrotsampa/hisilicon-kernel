...
typedef struct
{
    ...
    HDMI_HDCP_VERSION_E enHdcpVersion;		/**<Current HDCP version*//**<CNcomment:��ǰHDCP�汾*/
}HDMI_STATUS_S;
...
typedef struct hiHDMI_APP_ATTR_S
{
    ...
    HDMI_COLORSPACE_E	    enOutColorSpace;	   /**<HDMI output vedio mode VIDEO_MODE_YCBCR,VIDEO_MODE_YCBCR444��VIDEO_MODE_YCBCR422��VIDEO_MODE_RGB444 *//**<CNcomment:HDMI�����Ƶģʽ��VIDEO_MODE_YCBCR444��VIDEO_MODE_YCBCR422��VIDEO_MODE_RGB444 */
    HDMI_DEEP_COLOR_E	    enDeepColorMode;	/**<Deep Color output mode,defualt: HI_UNF_HDMI_DEEP_COLOR_24BIT *//**<CNcomment:DeepColor���ģʽ, Ĭ��ΪHI_UNF_HDMI_DEEP_COLOR_24BIT */
    ...
    HI_BOOL		    bEnableDRMInfoFrame;   /**<Enable flag of DRM InfoFrame,suggestion:enable *//**<CNcomment:�Ƿ�ʹ�� DRM InfoFrame������Ĭ��ʹ�� */
    HDMI_HDCP_MODE_E	    enHDCPMode;		   /**<HDCP mode:HDMI_HDCP_MODE_NONE, HDMI_HDCP_MODE_1_4, HDMI_HDCP_MODE_2_2*//**<CNcomment:< HDCPģʽ��HDMI_HDCP_MODE_NONE(��HDCP)��HDMI_HDCP_MODE_1_4��HDMI_HDCP_MODE_2_2��Ĭ��Ϊ HDMI_HDCP_MODE_NONE*/
}HDMI_APP_ATTR_S;
...
typedef struct
{
   ...
   // struct task_struct  *kThreadCec;	    /*CEC thread*//*CNcomment: CEC�߳� */
}HDMI_THREAD_INFO_S;
