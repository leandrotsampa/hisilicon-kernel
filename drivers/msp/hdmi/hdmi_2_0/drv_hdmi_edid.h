...
{
    HI_BOOL	bYccQrangeSelectable;	/**<flag of RGB Quantization Range selectable.when HI_TRUE,sink expect full/limited range is selectable;or sink expect default range.  *//**<CNcomment:Sink��a?��RGB��??����??�쨺?��??��/?T?? ��??��?��???��HI_TRUE������?sink��a?����??��?��??��?HI_FALSE������?sink��a?��??��?��??��?��*/
    HI_BOOL	bRgbQrangeSelectable;	/**<flag of YCC Quantization Range selectable.when HI_TRUE,sink expect full/limited range is selectable;or sink expect default range.  *//**<CNcomment:Sink��a?��YCC��??����??�쨺?��??��/?T?? ��??��?��???��HI_TRUE������?sink��a?����??��?��??��?HI_FALSE������?sink��a?��??��?��??��?��*/
    ...
    HDMI_EDID_DOLBY_CAPS_U unOtherCaps; /* other caps in Dolby VSVDB. distinction between V0(u8VSVDBVersion=0) and V1(u8VSVDBVersion=1).*//**<CNcomment:Dolby����������������Dolby VSVDB�汾V0(u8VSVDBVersion=0)��V1������(u8VSVDBVersion=1)*/
