...
/*
    ...
    HI_U32 vpss_tmp_width       = 0;
    HI_U32 vpss_tmp_height      = 0;
    HI_U32 vpss_tmp_format      = 0;
    HI_U32 vpss_vhd0_tmp_width  = 0;
    ...
    HI_U32 mcstartr            = vpss_reg->VPSS_MCDI_LCDINEW0.bits.mcstartr               ;
    HI_U32 mcstartc            = vpss_reg->VPSS_MCDI_LCDINEW0.bits.mcstartc               ;
    HI_U32 mcendr              = vpss_reg->VPSS_MCDI_LCDINEW0.bits.mcendr                 ;
    HI_U32 mcendc              = vpss_reg->VPSS_MCDI_LCDINEW0.bits.mcendc                 ;
    ...
    HI_U32 dei_lmmode          = vpss_reg->VPSS_DIECTRL.bits.die_l_mode ;
    ...
    if (tnr_en == 1)
    {
        ...
        if (vpss_tmp_width > 720)
        {
            VPSS_ASSERT(rgme_en == 0);
        }
        if (vpss_tmp_height > 576)
        {
            VPSS_ASSERT(rgme_en == 0);
        }
    ...
    vpss_vhd0_tmp_width  = vpss_tmp_width ;
    ...
    if (rotate_en == 1)
    {
        ...
        VPSS_ASSERT(vhd0_pix_bitw == 0);
        VPSS_ASSERT((img_pro_mode == 1) || (img_pro_mode == 2));

        vpss_vhd0_tmp_width  = vpss_tmp_height ;
        vpss_vhd0_tmp_height = vpss_tmp_width;
        vpss_vhd0_tmp_format = 0;
    }
