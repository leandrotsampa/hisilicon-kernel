...
typedef enum hiVPSS_HAL_NODE_TYPE_E //根据逻辑设计走
{
    ...
    VPSS_HAL_NODE_ROTATION_Y        = 15,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_Y_VIRTUAL = 16,
    VPSS_HAL_NODE_ROTATION_C        = 17,//Y,C翻转
    VPSS_HAL_NODE_ROTATION_C_VIRTUAL = 18,

    VPSS_HAL_NODE_HDR_DETILE_NOALG  = 19,

    VPSS_HAL_NODE_2D_H265_STEP1_INTERLACE       = 20,
    VPSS_HAL_NODE_2D_H265_STEP2_DEI             = 21,

    VPSS_HAL_NODE_2D_DEI_LAST_2FIELD            = 22,
    VPSS_HAL_NODE_2D_DEI_LAST_2FIELD_VIRTUAL    = 23,
