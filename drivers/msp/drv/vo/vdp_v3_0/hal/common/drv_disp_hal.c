...
#if defined(CHIP_TYPE_hi3719mv100) || defined(CHIP_TYPE_hi3718mv100) || defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100) || defined(CHIP_TYPE_hi3716dv100) || defined(CHIP_TYPE_hi3716mv410) || defined(CHIP_TYPE_hi3716mv420)
							   ...
							   HI_U32 u32Fidelity)
{
	...
	stZmeI.bZmeBFIn  = eWbcFieldMode_In;
    ...
    stZmeI.bZmeBFOut = eWbcFieldMode_Out;
