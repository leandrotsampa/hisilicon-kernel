                               ...
                               const HI_DRV_DISP_CALLBACK_INFO_S *pstInfo)
{
    ...
    if (pstInfo->stDispInfo.eFmt == HI_DRV_DISP_FMT_1440x576i_50
...
HI_S32 DISP_Acquire_Snapshot(HI_DRV_DISPLAY_E enDisp, HI_VOID **snapshotHandle, HI_DRV_VIDEO_FRAME_S *pstFrame)
{
    ...
    *snapshotHandle  = 0;
    ...
    if (stOutputSize.s32Width > 1920)
    {
        stOutputSize.s32Width = 1920;
    }

    if (stOutputSize.s32Height > 1080)
    {
        stOutputSize.s32Height = 1080;
    }
