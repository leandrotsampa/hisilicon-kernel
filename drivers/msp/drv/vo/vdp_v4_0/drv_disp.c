...
HI_U8 *g_pDispHisiHdrCfgModeString[DRV_HISI_HDR_CFG_MODE_BUTT] = {
    ...
    "DRV_HISI_AVS_IN_HDR10_OUT",
    "DRV_HISI_AVS_IN_SDR_OUT",
...
static HI_VOID DISP_HisiHdrProcRead(struct seq_file *p,DISP_PROC_INFO_S *pstDispAttr)
{
    ...
    PROC_PRINT(p, "%-20s:%s\n", "HdrCfg->inCS",
      g_pVDPColorSpaceString[pstDispAttr->stHdrProcInfo.stHisiHdrProcInfo.stHisiHdrCfg.enInColorSpace]);
...
HI_DRV_DISP_FMT_E DispGetFmtbyString(HI_CHAR *pFmtString)
{
    ...
    else if (0 == HI_OSAL_Strncmp(pFmtString, "vesa", strlen("vesa")))
    {
        return HI_DRV_DISP_FMT_VESA_1280X720_60;
    }
    else
    {
...
HI_S32 DispProcCmdProcee(HI_DRV_DISPLAY_E enDisp, HI_CHAR *pArg1,HI_CHAR *pArg2)
{
    ...
    else if (0 == HI_OSAL_Strncmp(pArg1, "config_check", strlen("config_check")))
    {
        if (0 == HI_OSAL_Strncmp(pArg2, "video", strlen("video")))
        {
            (HI_VOID)DISP_CheckRegConfig("video");
        }
        else if (0 == HI_OSAL_Strncmp(pArg2, "wbc_dhd", strlen("wbc_dhd")))
        {
            (HI_VOID)DISP_CheckRegConfig("wbc_dhd");
        }
    }
    else if (0 == HI_OSAL_Strncmp(pArg1, "reg_save", strlen("reg_save")))
    {
    }
    else
    {
