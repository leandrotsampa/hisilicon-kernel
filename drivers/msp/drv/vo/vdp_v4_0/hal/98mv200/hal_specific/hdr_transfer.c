...
HI_VOID HAL_TransferToHiHalHdrCfg(HI_DRV_DISP_HISI_HDR_CFG_S *pstDrvPara,VDP_HISI_HDR_CFG_S *pstHalHdrCfg)
{
    ...
    TransferToHalColorSpace(pstDrvPara->enInColorSpace, &pstHalHdrCfg->stSrcInfo.enSrcClrSpace);
    TransferToHalColorSpace(pstDrvPara->enOutColorSpace, &pstHalHdrCfg->stVdpDispInfo.enOutClrSpace);

    pstHalHdrCfg->stSrcInfo.bSdrFrm = HI_FALSE;
