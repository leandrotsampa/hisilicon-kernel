...
HI_VOID VDP_VDAC_SetClk(HI_DRV_DISPLAY_E enDisp,DISP_VENC_E eDate, HI_U32 uVdac)
{
    ...
    switch (uVdac)
    {
        ...
        case 0:
            ...
            break;
#endif
#if !(defined(CHIP_TYPE_hi3798mv100) || defined(CHIP_TYPE_hi3796mv100) || defined(CHIP_TYPE_hi3716dv100) || defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798mv200_a) || defined(CHIP_TYPE_hi3798mv200))
        case 1:
            if (DISP_VENC_VGA0 == eDate)
...
{
    VDP_HDR_CFG_S stHalHdrCfg = {0};

    memset(&stHalHdrCfg, 0x0, sizeof(VDP_HDR_CFG_S));
    HAL_TransferToDolbyHalHdrCfg(pstHdrCfg, &stHalHdrCfg);
    VDP_DRV_SetHdrMode(&stHalHdrCfg, pstCompCfg, pstDmKs);
...
HI_S32 PF_SetHisiHdrMode(HI_DRV_DISP_HISI_HDR_CFG_S *pstDrvHdrCfg,HI_PQ_HDR_CFG *pstPqHdrCfg)
{
    VDP_HISI_HDR_CFG_S stHalHdrCfg = {0};

    memset(&stHalHdrCfg,0x0,sizeof(VDP_HISI_HDR_CFG_S));
    HAL_TransferToHiHalHdrCfg(pstDrvHdrCfg, &stHalHdrCfg);
    VDP_DRV_SetHisiHdrMode(&stHalHdrCfg, pstPqHdrCfg);
