...
#if !defined(CHIP_TYPE_hi3798mv100) && !defined(CHIP_TYPE_hi3796mv100) && !defined(CHIP_TYPE_hi3716dv100) && defined(HI_ADVCA_TYPE_VERIMATRIX)
...
HI_S32 HAL_ADVCA_V300_SetKeyladderAttr(CA_KEYLADDER_ATTR_S *pstKeyladderAttr)
{
    ...
    {
        VMX_ADVCA_Swith(pTempstKeyladderAttr, pstKeyladderAttr);
    }
    else
    {
