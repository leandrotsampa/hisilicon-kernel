...
static HI_S32 MCE_SetVolume(HI_UNF_SND_E enSound, DRV_SND_ATTR_S *pstAttr, HI_U32 u32Volume,HI_BOOL bUseExtCfg)
{
    HI_U8 ii = 0;
    HI_U8 jj = 0;
...
HI_S32 MCE_GradualVol_Thread(HI_VOID *args)
{
    ...
    memcpy(&stSndAttr,(DRV_SND_ATTR_S *)args,sizeof(DRV_SND_ATTR_S));
