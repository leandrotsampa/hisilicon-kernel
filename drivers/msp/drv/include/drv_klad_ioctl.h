...
typedef struct hiKLAD_CTL_RKD_S
{
    HI_HANDLE handle;
    HI_UNF_KLAD_DCAS_PROFILE_MODE_E enMode;
    HI_UNF_KLAD_DCAS_MODULE_ID_E enModuleID;
    HI_U8 au8Data[HI_UNF_KLAD_MAX_KEY_LEN];
} KLAD_CTL_RKD_S;
...
#ifdef HI_ADVCA_DCAS_SUPPORT
#define CMD_KLAD_STRAT_RKD                  _IOW (HI_ID_CA, 0xe, KLAD_CTL_RKD_S)
#define CMD_KLAD_K30_GEN_DANONCE            _IOR (HI_ID_CA, 0xf, KLAD_CTL_DA_NONCE_S)
#define CMD_KLAD_K31_GEN_DANONCE            _IOR (HI_ID_CA, 0x10, KLAD_CTL_DA_NONCE_S)
#endif
