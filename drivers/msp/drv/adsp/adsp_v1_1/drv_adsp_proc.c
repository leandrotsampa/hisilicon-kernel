...
{
    HI_U32 j;
    volatile S_ADSP_CHN_REGS_TYPE* pADSPSysCrg = (volatile S_ADSP_CHN_REGS_TYPE*)(g_pDspShareSRam + DSP0_SHARESRAM_SYS_OFFSET);
...
#ifdef __DPT__
    g_pAfltRegAddr = g_pDspShareSRam + DSP0_SHARESRAM_AFLT_OFFSET;
#endif
