...
typedef struct
{
    ...
    UINT16 terminal_provider_code;
    UINT8 terminal_provider_oriented_code_message_idc;
...
typedef struct
{
    UINT8 is_avalible;
    UINT32 cv_rec_id;
    UINT8 cv_rec_cancel_flag;
    UINT8 cv_rec_persistence_flag;
    UINT8 cv_rec_target_info_flag;
    UINT8 cv_rec_primaries;
    UINT8 cv_rec_matrix_coefficients;
