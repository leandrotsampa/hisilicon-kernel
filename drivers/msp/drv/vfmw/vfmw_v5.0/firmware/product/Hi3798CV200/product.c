...
VOID PDT_InitHalInterface(VDMHAL_FUN_PTR_S *pFuncPtr)
{
    ...
    pFuncPtr->pfun_VDMHAL_UpdateHardwareInfo     = VDMHAL_V400R003_UpdateHardwareInfo;
    ...
    pFuncPtr->pfun_VDMHAL_IsVdhDecOver           = VDMHAL_V400R003_IsVdhDecOver;
    pFuncPtr->pfun_VDMHAL_IsVdhPartDecOver       = VDMHAL_V400R003_IsVdhPartDecOver;
#endif
