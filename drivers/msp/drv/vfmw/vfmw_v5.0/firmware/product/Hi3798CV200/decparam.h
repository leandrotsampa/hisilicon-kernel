...
typedef struct
{
    /* 寄存器信息 */
    /* BASIC_CFG0 */
    UINT32 vdh_safe_flag;
    UINT32 ld_qmatrix_flag;
    UINT32 luma_histogram_en;
    UINT32 luma_sum_en;
    UINT32 work_mode;
    UINT32 vop_type_detect_en;
    UINT32 coef_idx_detect_en;
    UINT32 ac_last_detect_en;
    UINT32 marker_bit_detect_en;
    UINT32 ctbamt_to_dec;
    /* BASIC_CFG1 */
    UINT32 ppfd_en;
    UINT32 frm_cmp_en;
    UINT32 vdh_2d_en;
    UINT32 line_num_output_en;
    UINT32 max_slcgrp_num;
    UINT32 mv_output_en;
    UINT32 fst_slc_grp;
    UINT32 uv_order_rn;
    UINT32 mfd_mmu_en;
    ...
    UINT32 line_num_addr;
    UINT32 Stride_2bit;
    UINT32 LumaOffset_2bit;
    UINT32 ChromOffset_2bit;

    /* 下行消息池*/
    /* burst0 */
    /*D0  D13  D14*/
    UINT32 pic_height_in_CtbsY_minus1;
    UINT32 pic_width_in_CtbsY_minus1;

    UINT32 pic_height_in_luma_samples;
    UINT32 pic_width_in_luma_samples;

    UINT32 PicHeightInBlksYMinus1;
    UINT32 PicWidthInBlksYMinus1;

    /*D1*/
    UINT32 top_field_pic_flag;
    UINT32 BitDepth;
    UINT32 pic_qp;
    UINT32 fix_qp;
    ...
    /*D3*/
    SINT32 secondary_transform_enable_flag;
    SINT32 weight_quant_enable;
    SINT32 chroma_quant_param_delta_cr;
    SINT32 chroma_quant_param_delta_cb;
    SINT32 chroma_quant_param_disable;
    SINT32 pic_weight_quant_enable;
    ...
    /*D5 ~ D12*/
    UINT32 Refp_top_field_pic_flag[7];
    UINT32 Ref_picture_structure  [7];
    UINT32 Refp_top_field_first   [7];
    UINT32 Refp_address           [7];

    UINT32 curp_top_field_pic_flag;
    UINT32 cur_picture_structure;
    UINT32 curp_top_field_first;
    ...
    UINT32 rcn_top_addr;
    UINT32 sao_top_addr;
    UINT32 dblk_top_addr;
    UINT32 colmv_wt_addr;
    UINT32 colmv_rd_addr;

    /*D22 ~ D57*/
    SINT32 alf_coeff_luma[16][9];
    SINT32 alf_coeff_chroma[2][9];

    /* burst1 */
    /*D0 ~ D15*/
    SINT16 sDistanceCurRef[8];
    SINT16 sDivCurRef[8];
    SINT16 sDistanceColRef[8];
    SINT16 sDivColRef[8];

    /*D25*/
    UINT32 Wqm_Shift;
    UINT32 pmvr_enable;
    UINT32 SceneReferenceEnable;
    UINT32 Col_Refp_top_field_pic_flag[7];

    UINT8  aucWQM_4x4[4][4]; //todo...在构建配置数据时，非32位宽变量左移是否有风险
    ...
    UINT32 SlcNum;
    AVS2_SLCINFO_S SlcInfo[AVS2_MAX_SLICE_NUM];
