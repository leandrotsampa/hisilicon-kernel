...
HI_S32 SCI_Open(HI_UNF_SCI_PORT_E enSciPort, HI_UNF_SCI_PROTOCOL_E enSciProtocol, HI_U32 Frequency)
{
    ...
    Ret = osal_request_irq(stPortAttr.u32IrqNo, SCI_Isr, IRQF_SHARED, s8Buff[enSciPort], (HI_VOID*)&hsciIRQ);
    if (Ret != HI_SUCCESS)
    {
...
HI_S32 SCI_Close(HI_UNF_SCI_PORT_E enSciPort)
{
    ...
    osal_free_irq(stPortAttr.u32IrqNo, s8Buff[enSciPort], (HI_VOID*)&hsciIRQ);
