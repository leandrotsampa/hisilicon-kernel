...
#ifdef CA_FRAMEWORK_V200_SUPPORT
    HAL_OTP_Read(0x258, &u32TrimData);
#else
    u32TrimData = HAL_OTP_V200_Read(0x258);
#endif

    /* get trim data */
#if defined(CHIP_TYPE_hi3798cv200) || defined(CHIP_TYPE_hi3798mv200) || defined(CHIP_TYPE_hi3798mv200_a)
    g_pstRegSysCtrl->SC_GENx[4] = u32TrimData;
#else
    g_pstRegSysCtrl->SC_GEN28 = u32TrimData;
#endif
