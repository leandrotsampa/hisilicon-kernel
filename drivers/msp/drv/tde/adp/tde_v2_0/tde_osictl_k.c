...
#define TDE_CHECK_DST_FMT(enFmt) do\
    {\
        ...
        {\
            TDE_ERROR("This operation doesn't Clut&&A1!\n");\
            return HI_ERR_TDE_INVALID_PARA;\
        }\
    }while(0)
...
#define TDE_STRIDE_CHECK_ALIGN(u32Stride, u32AlignNum)\
    do{\
        ...
        {\
            TDE_ERROR("stride is not aligned! %s\n");\
...
STATIC TDE_OPERATION_CATEGORY_E TdeOsiSingleSrcOperation(
        TDE2_SURFACE_S* pstForeGround,
        ...
        TDE2_OPT_S*      pstOpt)
{
    ...
    {
        return TdeOsiSingleSrcOperation(pstForeGround, pstForeGroundRect, pstDst, pstDstRect, pstOpt);
    }
    else
    {
        return TdeOsiSingleSrcOperation(pstBackGround, pstBackGroundRect,pstDst, pstDstRect, pstOpt);
    }
