...
static HI_VOID PQ_HAL_SetSharpConfig(HI_PQ_LAYER_STRATEGY_IN_S *pstZmeIn, HI_PQ_LAYER_STRATEGY_OUT_S *pstZmeOut)
{
    ...
    if (((pstZmeOut->stZmeFmt[0].u32FrmInWidth <= SHARPEN_SUPPOR_MAX_WITDH)
         || (pstZmeOut->stZmeFmt[0].u32FrmInHeight <= SHARPEN_SUPPOR_MAX_HEIGHT))
        &&
    ...
    {
        if ((pstZmeOut->stZmeFmt[1].u32FrmOutWidth == pstZmeOut->stZmeFmt[1].u32FrmInWidth * V0_SCALER1_ENABLE_THD)
            && (pstZmeOut->stZmeFmt[1].u32FrmOutHeight == pstZmeOut->stZmeFmt[1].u32FrmInHeight * V0_SCALER1_ENABLE_THD)
            && ((HI_TRUE == pstZmeOut->bZmeFirHL) || (HI_TRUE == pstZmeOut->bZmeFirHC)
                || (HI_TRUE == pstZmeOut->bZmeFirVL) || (HI_TRUE == pstZmeOut->bZmeFirVC)))
        {
