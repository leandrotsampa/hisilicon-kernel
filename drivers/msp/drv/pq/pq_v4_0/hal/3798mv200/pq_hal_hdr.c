...
static HI_S16 as16WorkM33R2Y_709_S78[3][3] =                  /* S1.14 [-32768, 32767] */
{
    /* BT709_SAT78 */
    {2984  ,     10034   ,     1013  },
    { -1282 ,      -4314  ,      5596 },
...
static HI_S32 pq_hal_GetHDR10toSDRCfg(HI_PQ_HDR_CFG *pstPqHdrCfg)
{
    ...
    memcpy(pstPqHdrCfg->stR2Y.as16M33R2Y, as16WorkM33R2Y_709_S78, sizeof(HI_S16) * 9);
...
HI_S32 PQ_HAL_SetHDRSaturation(HI_U32 u32Saturation)
{
    ...
    HI_S32 i = 0, j = 0;
    HI_S32 s32Gain = (HI_S32)u32Saturation;
    ...
    for (i = 1; i < 3; i++)
    {
        for (j = 0; j < 3; j++)
        {
            as16WorkM33R2Y_709_S78[i][j] = as16M33R2Y_709_S78[i][j] +
                                           as16M33R2Y_709_S78[i][j] * (s32Gain - 50) / 100;
        }
    }
