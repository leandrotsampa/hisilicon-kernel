...
HI_S32 HAL_HDMI_CtrlAudioEnable(HDMI_DEVICE_ID_E enHdmi,HDMI_AUDIO_INTERFACE_E enAudioIntf,HI_BOOL bEnable)
{
	CTRL_AUDIO_EN_S stAudioEn = {0};

	if (bEnable)
	{
		stAudioEn.bAudioInEnable	= HI_TRUE;
		stAudioEn.bAudioMuteEnable	= HI_FALSE;
	...
	{
		stAudioEn.bAudioInEnable	= HI_FALSE;
		stAudioEn.bAudioMuteEnable	= HI_TRUE;
	...
	HDMI_TX_AUDIO_CTRL_aud_in_enSet(stAudioEn.bAudioInEnable);
	HDMI_TX_AUDIO_CTRL_aud_mute_enSet(stAudioEn.bAudioMuteEnable);
...
HI_S32 HAL_HDMI_CtrlAudioPathSet(HDMI_DEVICE_ID_E enHdmi,HDMI_AUDIO_PATH_S *pstAudioPath)
{
	...
	HAL_HDMI_CtrlAudioEnable(enHdmi,pstAudioPath->enSoundIntf,HI_FALSE);
    CtrlAudioReset();
    ...
    DRV_HDMI_CompatAudNCtsGet(enHdmi, &u32Nvalue, &u32CTSvalue);
