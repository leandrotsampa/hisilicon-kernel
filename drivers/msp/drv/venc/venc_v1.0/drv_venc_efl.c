...
HI_VOID VENC_DRV_EflRcCalPFrmQpByPicState(VeduEfl_Rc_S* pRc, HI_S32 FrameIMBRatio)
{
...
HI_VOID VENC_DRV_EflRcCalPFrmQpByPreInfo(VeduEfl_Rc_S* pRc, VeduEfl_EncPara_S* pEncPara)
{
    HI_S32 ratio, ratio2;
...
HI_S32 VENC_DRV_EflRcOpenOneFrm( VeduEfl_EncPara_S* EncHandle)
{
    ...
    else
    {
        ...
        else
        {
            ...
            if (pEncPara->stRc.SceneChangeFlag == 1)
            {
                HI_S32 TempQp = 0;
