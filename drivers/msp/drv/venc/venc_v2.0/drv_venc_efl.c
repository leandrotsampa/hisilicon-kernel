...
extern HI_BOOL gIsAcqureOver;
HI_BOOL gIsOnePicEnd = 0;
#endif
...
#if ( defined(VENC_98MV200_CONFIG) )
...
static HI_S32 VeduEfl_PME_SetDefaultAttr  (VeduEfl_PmeAttr_S *pPmeAttr )
{
  ...
  pPmeAttr->skin_num        = 0x70;
  pPmeAttr->skin_v_min_thr  = 0x83 ; 
  pPmeAttr->skin_v_max_thr  = 0xa0;
  pPmeAttr->skin_u_min_thr  = 0x64;
  pPmeAttr->skin_u_max_thr  = 0x80;

  pPmeAttr->still_scene_thr = 1;
  pPmeAttr->high_edge_cnt   = 0x3;
  pPmeAttr->high_edge_thr   = 0x19;

  pPmeAttr->move_sad_thr   = 378 ;
  pPmeAttr->move_scene_thr = 3 ;
  pPmeAttr->interstrongedge_madi_thr     = 128 ;
  pPmeAttr->interdiff_max_min_madi_times = 3 ;
  pPmeAttr->interdiff_max_min_madi_abs   = 8 ;

  pPmeAttr->cost_lamda_en = 0;
  pPmeAttr->new_cost_en   = 0;
  pPmeAttr->cost_lamda1   = 2;
  ...
  pPmeAttr->pme_high_luma_thr           = 60;
  pPmeAttr->pme_inter_first             = 0;

  pPmeAttr->low_luma_thr        = 0;
  pPmeAttr->low_luma_madi_thr   = 5;
...
static HI_S32 VeduEfl_QPG_SetDefaultAttr(VeduEfl_QpgAttr_S* pQpgAttr, HI_U32 Protocol)
{
    int i;
    ...
    {
        pQpgAttr->cu_qp_delta_thresh[0]  = 0;
        pQpgAttr->cu_qp_delta_thresh[1]  = 0;
        pQpgAttr->cu_qp_delta_thresh[2]  = 0;
        pQpgAttr->cu_qp_delta_thresh[3]  = 0;
        pQpgAttr->cu_qp_delta_thresh[4]  = 0;
        pQpgAttr->cu_qp_delta_thresh[5]  = 7;
        pQpgAttr->cu_qp_delta_thresh[6]  = 7;
        pQpgAttr->cu_qp_delta_thresh[7]  = 7;

        pQpgAttr->cu_qp_delta_thresh[8]  = 9;
        pQpgAttr->cu_qp_delta_thresh[9]  = 11;
        pQpgAttr->cu_qp_delta_thresh[10] = 14;
        pQpgAttr->cu_qp_delta_thresh[11] = 18;
        pQpgAttr->cu_qp_delta_thresh[12] = 25;
        pQpgAttr->cu_qp_delta_thresh[13] = 255;
        pQpgAttr->cu_qp_delta_thresh[14] = 255;
        pQpgAttr->cu_qp_delta_thresh[15] = 255;
    }
    else
    {
        pQpgAttr->cu_qp_delta_thresh[0]  = 0 ;
        ...
        pQpgAttr->cu_qp_delta_thresh[2]  = 0 ;
        pQpgAttr->cu_qp_delta_thresh[3]  = 0 ;
        pQpgAttr->cu_qp_delta_thresh[4]  = 3 ;
        pQpgAttr->cu_qp_delta_thresh[5]  = 3 ;
        pQpgAttr->cu_qp_delta_thresh[6]  = 5 ;
        pQpgAttr->cu_qp_delta_thresh[7]  = 5 ;

        pQpgAttr->cu_qp_delta_thresh[8]  = 10 ;
        pQpgAttr->cu_qp_delta_thresh[9]  = 15 ;
        pQpgAttr->cu_qp_delta_thresh[10] = 20 ;
        pQpgAttr->cu_qp_delta_thresh[11] = 255;
        pQpgAttr->cu_qp_delta_thresh[12] = 255;
        pQpgAttr->cu_qp_delta_thresh[13] = 255;
        pQpgAttr->cu_qp_delta_thresh[14] = 255;
        pQpgAttr->cu_qp_delta_thresh[15] = 255;
    }
    ...
    pQpgAttr->skin_max_qp        = 32;
    pQpgAttr->intra_det_max_qp   = 0x33;

    pQpgAttr->strong_edge_move_qp_delta = 0;
    pQpgAttr->large_move_qp_delta       = 0;
    pQpgAttr->strong_edge_qp_delta      = 0;
    pQpgAttr->skin_qp_delta             = 4;
    pQpgAttr->intra_det_qp_delta        = 0;

    pQpgAttr->h264_smooth_qp_delta  = 4;
    pQpgAttr->h264_smooth_qp_delta1 = 8;
    pQpgAttr->h264_smooth_max_qp    = 51;

    pQpgAttr->cu32_delta_low        = 12;
    pQpgAttr->cu32_delta_high       = 12;

    pQpgAttr->rc_cu_qp_en  = 1 ;
    pQpgAttr->rc_row_qp_en = 1 ;

    pQpgAttr->rc_cu_madi_en       = 1 ;
    pQpgAttr->move_scene_en       = 1 ;
    pQpgAttr->strong_edge_move_en = 1 ;
    ...
    pQpgAttr->rc_low_luma_en      = 1;
    pQpgAttr->qp_restrain_delta_blk16 = 4;
    pQpgAttr->qp_restrain_delta_blk32 = 4;
    pQpgAttr->qp_restrain_en          = 1;
    pQpgAttr->qp_restrain_madi_thr    = 5;
    pQpgAttr->qp_restrain_mode        = 0;
...
{
    pImgImproveAttr->highedge_en    = 1;
    pImgImproveAttr->skin_en        = 1;
    pImgImproveAttr->static_en      = 1;
    pImgImproveAttr->img_improve_en = 1;

    pImgImproveAttr->norm32_tr1_denois_max_num      = 4 ;
    pImgImproveAttr->norm32_coeff_protect_num       = 256 ;
    pImgImproveAttr->norm16_tr1_denois_max_num      = 3 ;
    pImgImproveAttr->norm16_coeff_protect_num       = 64 ;

    pImgImproveAttr->skin32_tr1_denois_max_num      = 4 ;
    pImgImproveAttr->skin32_coeff_protect_num       = 128 ;
    pImgImproveAttr->skin16_tr1_denois_max_num      = 3 ;
    pImgImproveAttr->skin16_coeff_protect_num       = 64 ;

    pImgImproveAttr->static32_tr1_denois_max_num    = 8 ;
    pImgImproveAttr->static32_coeff_protect_num     = 32  ;
    pImgImproveAttr->static16_tr1_denois_max_num    = 4 ;
    pImgImproveAttr->static16_coeff_protect_num     = 16  ;

    pImgImproveAttr->hedge32_tr1_denois_max_num     = 8 ;
    pImgImproveAttr->hedge32_coeff_protect_num      = 32  ;
    pImgImproveAttr->hedge16_tr1_denois_max_num     = 4 ;
    pImgImproveAttr->hedge16_coeff_protect_num      = 16  ;

    pImgImproveAttr->edgemov32_tr1_denois_max_num   = 6 ;
    pImgImproveAttr->edgemov32_coeff_protect_num    = 32  ;
    pImgImproveAttr->edgemov16_tr1_denois_max_num   = 4 ;
    pImgImproveAttr->edgemov16_coeff_protect_num    = 16  ;
    ...
    pImgImproveAttr->roundingMechanism              = 1 ;
    ...
    pImgImproveAttr->roundingSkinMechanism              = 1 ;
    ...
    pImgImproveAttr->roundingStillMechanism             = 1 ;
    ...
    pImgImproveAttr->roundingEdgeMechanism              = 1 ;
    ...
    pImgImproveAttr->roundingedgemovmechanism           = 1;
    pImgImproveAttr->roundingedgemovdegreethresh        = 0;
    pImgImproveAttr->roundingedgemovforcezeroresidthresh= 0;
    pImgImproveAttr->roundingedgemovac32sum             = 0;
    pImgImproveAttr->roundingedgemovac16sum             = 0;
    pImgImproveAttr->roundingedgemovlowfreqacblk32      = 0;
    pImgImproveAttr->roundingedgemovlowfreqacblk16      = 0;
...
#if ( defined(VENC_96MV200_CONFIG) )
    pImgImproveAttr->roundingoffset16x16 = 0;

    pImgImproveAttr->norm_isolate_ac_enable = 0;
    pImgImproveAttr->norm_force_zero_cnt = 0;
    pImgImproveAttr->norm_engsum_16 = 0;
    pImgImproveAttr->norm_engcnt_16 = 0;

	pImgImproveAttr->roundingskinoffset16x16 = 0;

    pImgImproveAttr->skin_isolate_ac_enable = 0;
    pImgImproveAttr->skin_force_zero_cnt = 0;
    pImgImproveAttr->skin_engsum_16 = 0;
    pImgImproveAttr->skin_engcnt_16 = 0;

	pImgImproveAttr->roundingedgeoffset16x16 = 0;

    pImgImproveAttr->stredge_isolate_ac_enable = 0;
    pImgImproveAttr->stredge_force_zero_cnt = 0;
    pImgImproveAttr->stredge_engsum_16 = 0;
    pImgImproveAttr->stredge_engcnt_16 = 0;

	pImgImproveAttr->roundingedgemovoffset16x16 = 0;
	pImgImproveAttr->roundingstilloffset16x16 = 0;

    pImgImproveAttr->still_isolate_ac_enable = 0;
    pImgImproveAttr->still_force_zero_cnt = 0;
    pImgImproveAttr->still_engsum_16 = 0;
    pImgImproveAttr->still_engcnt_16 = 0;

    pImgImproveAttr->sobelstr16_coeff_protect_num = 0;
    pImgImproveAttr->sobelstr16_tr1_denois_max_num = 0;
    pImgImproveAttr->roundingsobelstroffset16x16 = 0;

    pImgImproveAttr->roundingsobelstrmechanism = 0;
    pImgImproveAttr->roundingsobelstrdegreethresh = 0;
    pImgImproveAttr->roundingsobelstrforcezeroresidthresh = 0;
    pImgImproveAttr->roundingsobelstrac16sum = 0;
    pImgImproveAttr->roundingsobelstrlowfreqacblk16 = 0;

    pImgImproveAttr->sobelstr_isolate_ac_enable = 0;
    pImgImproveAttr->sobelstr_force_zero_cnt = 0;
    pImgImproveAttr->sobelstr_engsum_16 = 0;
    pImgImproveAttr->sobelstr_engcnt_16 = 0;
#endif
...
#endif
#if defined(VENC_96MV200_CONFIG)
HI_S32 VeduEfl_BASE_SetDefaultAttr(VeduEfl_BaseAttr_S* pBaseAttr)
{
    pBaseAttr->lcu_target_bit = 0 ;
    pBaseAttr->vcpi_dbgmod = 0 ;
    pBaseAttr->vcpi_bkp_en = 0 ;
    pBaseAttr->vcpi_time_en = 1 ;
    pBaseAttr->vedu_timeout = 1 ;

    //pBaseAttr->vcpi_cfg_mode = 1 ; //1:链表 0:cfg配置寄存器方式
    pBaseAttr->vcpi_lcu_time_sel = 0 ;
    pBaseAttr->vcpi_vedsel = 0 ;
    //pBaseAttr->vcpi_slice_int_en = 0 ;//根据低延迟配置要对齐

    pBaseAttr->vcpi_cnt_clr = 0 ;
    pBaseAttr->vcpi_frame_no = 0 ;
    pBaseAttr->IntraPeriod = 1 ;
    pBaseAttr->vcpi_bp_lcu_y = 1 ;
    pBaseAttr->vcpi_bp_lcu_x = 1 ;

    pBaseAttr->vcpi_cb_qp_offset = 0 ;
    pBaseAttr->vcpi_cr_qp_offset = 0 ;
    pBaseAttr->vcpi_frm_qp = 32 ;
    pBaseAttr->max_qp = 32 ;
    pBaseAttr->min_qp = 32 ;

    pBaseAttr->vcpi_blk_type = 0 ;
    pBaseAttr->vcpi_store_mode = 0 ;
    pBaseAttr->vcpi_byte_stuffing = 0 ;
    pBaseAttr->vcpi_cabac_init_idc = 0 ;

    pBaseAttr->vcpi_num_refidx = 0 ;
    pBaseAttr->vcpi_ref_idc = 0 ;
    pBaseAttr->vcpi_package_sel = 0 ;
    pBaseAttr->recst_disable = 0 ;
    pBaseAttr->vcpi_str_fmt = 0 ;
    pBaseAttr->vcpi_ref0_cmp_en = 0 ;
    pBaseAttr->vcpi_ref1_cmp_en = 0 ;
    pBaseAttr->vcpi_mrg_cu_en = 0x7 ;
    pBaseAttr->vcpi_fme_cu_en = 0x7 ;
    pBaseAttr->mrg_pu8_bias_cost = 0 ;
    pBaseAttr->mrg_pu16_bias_cost = 0 ;
    pBaseAttr->mrg_pu32_bias_cost = 0 ;
    pBaseAttr->mrg_pu64_bias_cost = 0 ;
    pBaseAttr->fme_pu8_bias_cost = 0 ;
    pBaseAttr->fme_pu16_bias_cost = 0 ;
    pBaseAttr->fme_pu32_bias_cost = 0 ;
    pBaseAttr->fme_pu64_bias_cost = 0 ;
    pBaseAttr->vcpi_intra_h264_cutdiag = 0 ;

    pBaseAttr->vcpi_inter8x8_en = 0  ;
    pBaseAttr->vcpi_rec_cmp_en = 0 ;
    pBaseAttr->vcpi_high_speed_en = 0 ;
    pBaseAttr->vcpi_lcu_size = 0 ;
    pBaseAttr->vcpi_blk8_inter  = 0;
    pBaseAttr->vcpi_sobel_weight_en  = 0;
    pBaseAttr->vcpi_pskp_en = 0 ;
    pBaseAttr->vcpi_refc_nload = 0 ;
    pBaseAttr->vcpi_tiles_en = 0 ;
    pBaseAttr->vcpi_idr_pic = 1 ;

    pBaseAttr->vcpi_dblk_filter_flag = 0 ;
    pBaseAttr->vcpi_dblk_alpha = 0 ;
    pBaseAttr->vcpi_dblk_beta = 0 ;
    pBaseAttr->vcpi_tmv_wr_rd_avail = 3;
    pBaseAttr->vcpi_cross_tile = 0 ;
    pBaseAttr->vcpi_cross_slice = 1;
    pBaseAttr->inter_avail = 0 ;
    pBaseAttr->intra_smooth = 0 ;

    pBaseAttr->intra_dc_shift_en = 0 ;
    pBaseAttr->intra_dc_16mode_en = 0 ;
    pBaseAttr->intra_dc_8mode_en = 0 ;
    pBaseAttr->intra_dc_4mode_en = 0 ;
    pBaseAttr->intra_dc_16shift = 0 ;
    pBaseAttr->intra_dc_8shift = 0 ;
    pBaseAttr->intra_dc_4shift = 0 ;

    pBaseAttr->intra_bit_weight = 0 ;

    pBaseAttr->intra_dc_4madi = 0 ;
    pBaseAttr->intra_dc_8madi = 0 ;
    pBaseAttr->intra_dc_16madi = 0 ;

    pBaseAttr->intra_cu4_rdo_cost_offset = 0 ;
    pBaseAttr->intra_cu8_rdo_cost_offset = 0 ;
    pBaseAttr->intra_cu16_non_dc_mode_offset = 0 ;
    pBaseAttr->intra_cu32_non_dc_mode_offset = 0 ;
    pBaseAttr->intra_cu4_non_dc_mode_offset = 0 ;
    pBaseAttr->intra_cu8_non_dc_mode_offset = 0 ;
    pBaseAttr->intra_cu4_mode0_31_en = 0xFFFFFFFF ;
    pBaseAttr->intra_cu4_mode32_34_en = 0x7 ;
    pBaseAttr->intra_cu8_mode0_31_en = 0xFFFFFFFF ;
    pBaseAttr->intra_cu8_mode32_34_en = 0x7  ;
    pBaseAttr->intra_cu16_mode0_31_en = 0xFFFFFFFF ;
    pBaseAttr->intra_cu16_mode32_34_en = 0x7  ;
    pBaseAttr->intra_cu32_mode0_31_en = 0xFFFFFFFF ;
    pBaseAttr->intra_cu32_mode32_34_en = 0x7  ;
    pBaseAttr->h264chroma_mode0_en	=	1;
    pBaseAttr->h264chroma_mode1_en	=	1;
    pBaseAttr->h264chroma_mode2_en	=	1;
    pBaseAttr->h264chroma_mode3_en	=	1;
    pBaseAttr->vcpi_tile_height = 0 ;
    pBaseAttr->vcpi_tile_width = 0 ;
    pBaseAttr->vcpi_pblk_pre_en = 0;
    pBaseAttr->vcpi_iblk_pre_en = 0;
    pBaseAttr->vcpi_force_inter = 0;
    pBaseAttr->vcpi_ext_edge_en = 1;
    pBaseAttr->vcpi_pintra_inter_flag_disable = 1;

    pBaseAttr->vcpi_pblk_pre_cost_thr = 100 ;
    pBaseAttr->vcpi_iblk_pre_cost_thr = 500;
    pBaseAttr->vcpi_iblk_pre_mvy_thr = 0x5 ;
    pBaseAttr->vcpi_iblk_pre_mvx_thr = 0x5 ;
    pBaseAttr->vcpi_iblk_pre_mv_dif_thr1 = 0xF ;
    pBaseAttr->vcpi_iblk_pre_mv_dif_thr0 = 0xF ;

    pBaseAttr->pblk_pre_mvx_thr = 2;
    pBaseAttr->pblk_pre_mvy_thr = 2;

    pBaseAttr->vcpi_skin_close_angle = 1 ;
    pBaseAttr->vcpi_rounding_sobel_en = 0 ;

    pBaseAttr->vcpi_long_term_refpic = 0 ;
    pBaseAttr->vcpi_ref_num = 0 ;
    pBaseAttr->num_ref_idx_l0_active_minus1 = 0 ;
    pBaseAttr->num_ref_idx_l1_active_minus1 = 0 ;
    pBaseAttr->short_term_ref_pic_set_idx = 0 ;
    pBaseAttr->num_short_term_ref_pic_sets = 1 ;

    pBaseAttr->ime_no_intra_ang_en	=	0;
    pBaseAttr->ime_no_intra_ang_cost_thr	=	0;
    pBaseAttr->ime_no_intra_ang_mvx_thr	=	0;
    pBaseAttr->ime_no_intra_ang_mvy_thr	=	0;
    pBaseAttr->vcpi_lambdaoff16 = 0 ;
    pBaseAttr->vcpi_lambdaoff8 = 0 ;

    pBaseAttr->pack_sybtax_config = 0 ;
    pBaseAttr->vcpi2cu_qp_min_cu_size = 0x2 ;
    pBaseAttr->vcpi2cu_tq_bypass_enabled_flag = 0 ;
    pBaseAttr->vcpi2pu_log2_max_ipcm_cbsizey = 3 ;
    pBaseAttr->vcpi2pu_log2_min_ipcm_cbsizey = 3 ;
    pBaseAttr->vcpi2res_tf_skip_enabled_flag = 0 ;

    pBaseAttr->byte_stuff_en = 0 ;
    pBaseAttr->force_zero_en = 0 ;
    pBaseAttr->force_y_zero_en = 0 ;
    pBaseAttr->force_u_zero_en = 0 ;
    pBaseAttr->force_v_zero_en = 0 ;
    pBaseAttr->force_skip_en	=	0;
    pBaseAttr->pmv_poc[0] = 0;
    pBaseAttr->pmv_poc[1] = 0;
    pBaseAttr->pmv_poc[2] = 0;
    pBaseAttr->pmv_poc[3] = 0;
    pBaseAttr->pmv_poc[4] = 0;
    pBaseAttr->pmv_poc[5] = 0;

    pBaseAttr->vlc_svc_strm = 0 ;
    pBaseAttr->vlc_svc_en = 0 ;
    pBaseAttr->curld_clip_en = 0;
    pBaseAttr->curld_lowdly_en = 0;
    pBaseAttr->MaxDecPicBufferM1 = 0 ;
    pBaseAttr->MaxNumReorderPics = 0 ;

    pBaseAttr->vcpi_col_long_flag       = 0 ;
    pBaseAttr->vcpi_curr_ref_long_flag = 0 ;
    pBaseAttr->vcpi_col_from_l0_flag = 1 ;
    pBaseAttr->vcpi_predflag_sel       = 0 ;

    pBaseAttr->vcpi_pintra_pu16_std_th = 0  ;
    pBaseAttr->vcpi_pintra_pu32_std_th = 0 ;
    pBaseAttr->vcpi_pintra_pu16_angel_cost_th = 0;
    pBaseAttr->vcpi_pintra_pu32_angel_cost_th = 0 ;
    pBaseAttr->vcpi_insert_i_slc_en = 0;
    pBaseAttr->vcpi_insert_i_slc_idx = 0;
    pBaseAttr->refld_col2gray_en = 0 ;
    pBaseAttr->vcpi_clkdiv_en = 1;

#ifdef HI_SMMU_SUPPORT
    pBaseAttr->vcpi_nbild_bypass = 0 ;
    pBaseAttr->vcpi_pmeld_bypass = 0 ;
    pBaseAttr->vcpi_refyh_bypass = 0 ;
    pBaseAttr->vcpi_refch_bypass = 0 ;
    pBaseAttr->vcpi_refy_bypass = 0 ;
    pBaseAttr->vcpi_refc_bypass = 0 ;
    pBaseAttr->vcpi_pmeinfold0_bypass = 0 ;
    pBaseAttr->vcpi_pmeinfold1_bypass = 0 ;
    pBaseAttr->vcpi_srcy_bypass = 0 ;
    pBaseAttr->vcpi_srcu_bypass = 0 ;
    pBaseAttr->vcpi_srcv_bypass = 0 ;
#else
    pBaseAttr->vcpi_nbild_bypass = 1 ;
    pBaseAttr->vcpi_pmeld_bypass = 1 ;
    pBaseAttr->vcpi_refyh_bypass = 1 ;
    pBaseAttr->vcpi_refch_bypass = 1 ;
    pBaseAttr->vcpi_refy_bypass = 1 ;
    pBaseAttr->vcpi_refc_bypass = 1 ;
    pBaseAttr->vcpi_pmeinfold0_bypass = 1 ;
    pBaseAttr->vcpi_pmeinfold1_bypass = 1 ;
    pBaseAttr->vcpi_srcy_bypass = 1 ;
    pBaseAttr->vcpi_srcu_bypass = 1 ;
    pBaseAttr->vcpi_srcv_bypass = 1 ;
#endif
    pBaseAttr->vcpi_nbist_bypass = 0;
    pBaseAttr->vcpi_pmest_bypass = 0;
    pBaseAttr->vcpi_recyh_bypass = 0;
    pBaseAttr->vcpi_recch_bypass = 0;
    pBaseAttr->vcpi_recy_bypass = 0;
    pBaseAttr->vcpi_recc_bypass = 0;
    pBaseAttr->vcpi_pmeinfost_bypass = 0;
    pBaseAttr->vcpi_strm_bypass = 0;

    pBaseAttr->narrow_tile_width = 3;

	pBaseAttr->curld_col2gray_en = 0;
	pBaseAttr->curld_clip_en     = 0;

    pBaseAttr->clip_luma_min = 0;
    pBaseAttr->clip_luma_max = 255;
    pBaseAttr->clip_chrm_min = 0;
    pBaseAttr->clip_chrm_max = 255;

	pBaseAttr->cu_qp_delta_enable_flag = 1;

    return HI_SUCCESS;
}

HI_S32 VeduEfl_PME_SetDefaultAttr(VeduEfl_PmeAttr_S* pPmeAttr )
{
    int i;
    pPmeAttr->prdo_en = 0 ;
    pPmeAttr->l0_psw_adapt_en = 0 ;
    ...
    pPmeAttr->l0_psw_thr1     = 50;
    pPmeAttr->l0_psw_thr2     = 150;
    pPmeAttr->skipblk_pre_en = 0 ;
    pPmeAttr->skipblk_pre_cost_thr = 0 ;
    pPmeAttr->tr_weightx_2 = 12 ;
    pPmeAttr->tr_weightx_1 = 8 ;
    pPmeAttr->tr_weightx_0 = 4 ;
    pPmeAttr->tr_weighty_2 = 12 ;
    pPmeAttr->tr_weighty_1 = 8 ;
    pPmeAttr->tr_weighty_0 = 4 ;
    pPmeAttr->pme_pskip_strongedge_madi_thr = 0x14;
    pPmeAttr->pme_pskip_strongedge_madi_times = 0x3 ;
    pPmeAttr->sr_weight_2 = 2 ;
    pPmeAttr->sr_weight_1 = 4 ;
    pPmeAttr->sr_weight_0 = 6 ;
    pPmeAttr->pme_flat_u_thr_low = 0;
    pPmeAttr->pme_flat_u_thr_high = 0;
    pPmeAttr->pme_flat_v_thr_low = 0;
    pPmeAttr->pme_flat_v_thr_high = 0;

    pPmeAttr->pme_flat_high_luma_thr = 0;
    pPmeAttr->pme_flat_low_luma_thr = 0;
    pPmeAttr->pme_flat_luma_madi_thr = 0;
    pPmeAttr->pme_flat_pmemv_thr = 0;

    pPmeAttr->pme_flat_madi_times = 0;
    pPmeAttr->pme_flat_region_cnt = 0;
    pPmeAttr->pme_flat_icount_thr = 0;
    pPmeAttr->pme_flat_pmesad_thr = 0;

    pPmeAttr->pme_pskip_mvy_consistency_thr = 0 ;
    pPmeAttr->pme_pskip_mvx_consistency_thr = 0 ;
    pPmeAttr->pme_intrablk_det_cost_thr0 = 0x1ff ;

    pPmeAttr->pme_intrablk_det_mv_dif_thr1 = 5 ;
    pPmeAttr->pme_intrablk_det_mv_dif_thr0 = 5 ;
    pPmeAttr->pme_intrablk_det_mvy_thr = 0xf ;
    pPmeAttr->pme_intrablk_det_mvx_thr = 0xf ;
    ...
    {
        if (i * 4 < 60)
        { pPmeAttr->prdo_f1[i] = (150 << 8) / (150 + (60 - 4 * i)) - 1; }
        else if (i * 4 < 170)
        { pPmeAttr->prdo_f1[i] = 255 ; }
        else
        { pPmeAttr->prdo_f1[i] = (425 << 8) / (425 + (4 * i - 170)) - 1; }
    }

    for (i = 0; i < 64; i++)
    {
        if (i < 5)
        { pPmeAttr->prdo_f2[i] = 255 ; }
        else
        { pPmeAttr->prdo_f2[i] = 2560 / (i + 5) - 1; }
    }

    pPmeAttr->fg_detect_thr = 0 ;
    pPmeAttr->fg_detectcnt_thr = 0 ;
    pPmeAttr->move_sad_thr   = 378 ;
    pPmeAttr->move_scene_thr = 3 ;
    pPmeAttr->interstrongedge_madi_thr     = 128 ;
    pPmeAttr->interdiff_max_min_madi_times = 3 ;
    ...
    pPmeAttr->pme_min_sad_thr_offset_cur     = 0      ;
    pPmeAttr->pme_min_sad_thr_gain_cur   = 0      ;

    pPmeAttr->pme_pblk_pre_mv_dif_thr1   = 0      ;
    pPmeAttr->pme_pblk_pre_mv_dif_thr0     = 0      ;
    pPmeAttr->pme_pblk_pre_mv_dif_cost_thr   = 0      ;
...
HI_S32 VeduEfl_QPG_SetDefaultAttr  (VeduEfl_QpgAttr_S *pQpgAttr, HI_U32 Protocol)
{
    int i;
    pQpgAttr->qp_delta = 2 ;
    ...
    pQpgAttr->h264_lowluma_qp_delta = 0x4;
    pQpgAttr->h264_lowluma_max_qp  = 0x33;

    pQpgAttr->bfg_roi_qp_delta  = 0x33;
    pQpgAttr->strong_edge_max_qp  = 0x33;
    pQpgAttr->large_move_max_qp = 0x33  ;
    pQpgAttr->move_edge_max_qp = 0x33  ;
    pQpgAttr->stredge_move_min_qp = 0x0;
    pQpgAttr->skin_max_qp        = 32;
    pQpgAttr->intra_det_max_qp = 0x33;
    pQpgAttr->stredge_min_qp = 0;
    pQpgAttr->bfg_roi_qp_delta = 3 ;
    pQpgAttr->strong_edge_move_qp_delta = 0;
    pQpgAttr->large_move_qp_delta       = 0;
    pQpgAttr->strong_edge_qp_delta      = 0;
    pQpgAttr->skin_qp_delta             = 4;
    ...
    pQpgAttr->h264_smooth_qp_delta1 = 8;
    pQpgAttr->h264_smooth_max_qp = 51;
    pQpgAttr->ave_lcu_bits  = 0x01F4;
    pQpgAttr->row_target_bits  = 0;
    pQpgAttr->cu32_delta_low        = 12;
    pQpgAttr->cu32_delta_high       = 12;

    pQpgAttr->post_cu_high_switch_thr = 0x4 ;
    pQpgAttr->post_cu_low_switch_thr  = 0x4 ;
    pQpgAttr->post_cu_high_madi_thresh = 0x4 ;
    pQpgAttr->post_cu_low_madi_thresh = 0x4 ;
    pQpgAttr->post_qp_high_level = 0x5555;
    pQpgAttr->post_qp_low_level  = 0x5555;

    pQpgAttr->post_qp_low_thrsh[0] = 0x32 ;
    pQpgAttr->post_qp_low_thrsh[1] = 0x3C ;
    pQpgAttr->post_qp_low_thrsh[2] = 0x46 ;
    pQpgAttr->post_qp_low_thrsh[3] = 0x50 ;
    pQpgAttr->post_qp_low_thrsh[4] = 0x78 ;
    pQpgAttr->post_qp_low_thrsh[5] = 0x8C ;
    pQpgAttr->post_qp_low_thrsh[6] = 0xA0 ;
    pQpgAttr->post_qp_low_thrsh[7] = 0xB4;

    pQpgAttr->post_qp_high_thrsh[0] = 0x32 ;
    pQpgAttr->post_qp_high_thrsh[1] = 0x3C ;
    pQpgAttr->post_qp_high_thrsh[2] = 0x46 ;
    pQpgAttr->post_qp_high_thrsh[3] = 0x50 ;
    pQpgAttr->post_qp_high_thrsh[4] = 0x78 ;
    pQpgAttr->post_qp_high_thrsh[5] = 0x8C ;
    pQpgAttr->post_qp_high_thrsh[6] = 0xA0 ;
    pQpgAttr->post_qp_high_thrsh[7] = 0xB4;

    pQpgAttr->rc_cu_qp_en  = 1 ;
    pQpgAttr->rc_row_qp_en = 1 ;

    pQpgAttr->rc_line_mode_en = 0 ;
    pQpgAttr->rc_line_qp_delta = 0 ;

    pQpgAttr->rc_cu_madi_en       = 1 ;
    pQpgAttr->intra_det_qp_en = 0 ;

    pQpgAttr->qp_restrain_large_sad	=	0;
    pQpgAttr->post_rc_cu_en = 0 ;   //post
    pQpgAttr->post_cu_skin_en = 0 ;     //post
    ...
    pQpgAttr->rc_h264_smooth_mb_en = 0;
    pQpgAttr->qp_restrain_large_sad = 0;
    pQpgAttr->low_min_sad_en = 0;
    pQpgAttr->high_min_sad_en = 0;
    pQpgAttr->flat_region_en = 0;
...
static HI_S32 VeduEfl_LOWPOWER_SetDefaultAttr  (VeduEfl_LowPowerAttr_S* pLowPowerAttr)
{
    pLowPowerAttr->vcpi_high3pre_en = 0 ;
    pLowPowerAttr->flat_region_force_low3layer = 0 ;
    pLowPowerAttr->vcpi_ime_lowpow = 0 ;
    pLowPowerAttr->vcpi_force_intra_lowpwr_en = 0 ;
    pLowPowerAttr->vcpi_fme_lowpow = 0 ;
    pLowPowerAttr->vcpi_intra_lowpow = 0 ;
    pLowPowerAttr->vcpi_lowpow_fme_thr1 = 0xE ;
    pLowPowerAttr->vcpi_lowpow_fme_thr0 = 0x8 ;
    pLowPowerAttr->vcpi_clkgate_en = 0 ;
    pLowPowerAttr->vcpi_clkgate_en = 0 ;
    pLowPowerAttr->fme_gtck_en = 0 ;
    pLowPowerAttr->vcpi_ddr_cross_en = 0 ;
    pLowPowerAttr->tqitq_gtck_en = 0 ;
    pLowPowerAttr->vcpi_mem_clkgate_en = 0 ;

    return HI_SUCCESS;
}

HI_S32 VeduEfl_QSCALING_SetDefaultAttr(VeduEfl_QscalingAttr_S *pQscalingAttr)
{
    pQscalingAttr->deadzone_intra_slice = 0xab;
    pQscalingAttr->deadzone_inter_slice = 0x55;
...
static void Venc_SetRegDefault( VeduEfl_EncPara_S  *pEncPara )
{
    ...
    VeduEfl_QPG_SetDefaultAttr       (&(pEncPara->stHal.QpgCfg), pEncPara->Protocol);
    VeduEfl_PME_SetDefaultAttr       (&(pEncPara->stHal.PmeCfg));

#if defined(VENC_96MV200_CONFIG)
    VeduEfl_LOWPOWER_SetDefaultAttr  (&(pEncPara->stHal.LowPowerCfg));
    VeduEfl_BASE_SetDefaultAttr      (&(pEncPara->stHal.BaseCfg));
    VeduEfl_QSCALING_SetDefaultAttr  (&(pEncPara->stHal.QscalingCfg));
#endif
...
#if defined VENC_96MV200_CONFIG
    pEncPara->stHal.wOutStdNum       = 3;
    pEncPara->stHal.rOutStdNum       = 7;
#elif defined VENC_98MV200_CONFIG
...
HI_S32 VENC_DRV_EflCfgRegVenc( VeduEfl_EncPara_S* EncHandle )
{
   ...
   //add end
    ...
    if(EncHandle->stHal.RegConfigMode)
    {
...
static HI_VOID VENC_DRV_SetDefaultAttrByStartQP(VeduEfl_EncPara_S *pEncPara)
{
    HI_U32 DefaultAttrByQPIdx = 0;
    HI_U32 DefaultAttrFrmTypeIdx = 0;
    HI_U32 StartQP = 0;

    StartQP = pEncPara->stRc.StartQP;

    if (StartQP <= 25)
    {
        DefaultAttrByQPIdx = 0;
    }
    else if ((StartQP > 25) && (StartQP < 30))
    {
        DefaultAttrByQPIdx = 1;
    }
    else if ((StartQP >= 30) && (StartQP < 35))
    {
        DefaultAttrByQPIdx = 2;
    }
    else if ((StartQP >= 35) && (StartQP < 42))
    {
        DefaultAttrByQPIdx = 3;
    }
    else
    {
        DefaultAttrByQPIdx = 4;
    }

    DefaultAttrFrmTypeIdx = pEncPara->stRc.IsIntraPic ? 0 : 1;

    pEncPara->stHal.ImgImproveCfg = pEncPara->stEncParaTable[DefaultAttrFrmTypeIdx].ImgImproveCfg[DefaultAttrByQPIdx];
    pEncPara->stHal.QpgCfg = pEncPara->stEncParaTable[DefaultAttrFrmTypeIdx].QpgCfg[DefaultAttrByQPIdx];
    pEncPara->stHal.PmeCfg = pEncPara->stEncParaTable[DefaultAttrFrmTypeIdx].PmeCfg[DefaultAttrByQPIdx];
}
#endif
...
HI_S32 VENC_DRV_EflStartOneFrameVenc(VeduEfl_EncPara_S *EncHandle, VeduEfl_EncIn_S *pEncIn )
{
...
#if PARA_ADAPT_ENCODER
    VENC_DRV_SetDefaultAttrByStartQP(pEncPara);
#endif
    ...
    *(pEncPara->StrmBufRpVirAddr) = pstStrBuf->u32RdTail;
    *(pEncPara->StrmBufWpVirAddr) = pstStrBuf->u32WrHead;
#elif defined(VENC_96MV200_CONFIG)
    if ((pEncPara->stRc.IsIntraPic ) && (!pEncPara->stRc.Recode)) //当前帧进行重编无需再编码头信息
    {
        ...
        for (i = 0;i < 48;i++)
        {
            pEncPara->stHal.VEDU_HEADER[i] = 0;
        }
        pEncPara->stHal.vlcst_para_set_en = 1;

        if ((pEncPara->PrependSpsPpsEnable == HI_TRUE) || (pEncPara->stStat.GetFrameNumOK == 1))
        {
            if (pEncPara->Protocol != VEDU_H265)
            {
                pEncPara->stHal.HeaderRealLength = pEncPara->SpsBits / 8 + pEncPara->PpsBits / 8;
                pEncPara->stHal.vlcst_para_set_len = D_VENC_ALIGN_UP(pEncPara->stHal.HeaderRealLength, 64);
            ...
            {
                pEncPara->stHal.HeaderRealLength = pEncPara->SpsBits / 8 + pEncPara->PpsBits / 8 + pEncPara->VpsBits / 8;
                pEncPara->stHal.vlcst_para_set_len = D_VENC_ALIGN_UP(pEncPara->stHal.HeaderRealLength, 64);
            ...
            iBytes = pEncPara->stHal.HeaderRealLength;
            buf = (HI_U32*)StreamHeader;

            for (i = 0; iBytes > 0; i++, iBytes -= 4)
            {
                pEncPara->stHal.VEDU_HEADER[i] = buf[i] ;
            }
        }
    }
#endif
...
static HI_VOID TurnBackForLargeIFrame(VeduEfl_EncPara_S * pEncPara)
{
    VALG_CRCL_BUF_S* pstStrBuf = &pEncPara->stCycBuf;
    HI_BOOL IsWriteBack = HI_FALSE;
    HI_U32  ParaSetLen = (pEncPara->Protocol == VEDU_H265) ? 128 * 3 : 128 * 2;

    IsWriteBack = (pstStrBuf->u32WrHead > ParaSetLen) ? HI_FALSE : HI_TRUE;

    if (IsWriteBack)
    {
        pstStrBuf->u32WrHead = pstStrBuf->u32BufLen - (ParaSetLen - pstStrBuf->u32WrHead);
    }
    else
    {
        pstStrBuf->u32WrHead = pstStrBuf->u32WrHead - ParaSetLen;
    }
...
HI_S32 VENC_DRV_EflEndOneFrameVenc(VeduEfl_EncPara_S *EncHandle)
{
    ...
    if (!pEncPara->stRc.LowDlyMod)  // not use low delay mode
    {
        ...
        else
        {
            ...
            {
                 TurnBackForLargeIFrame(pEncPara);
            }
...
#if defined VENC_96MV200_CONFIG
HI_S32 VENC_DRV_EflAllocSliceBuf(VENC_BUFFER_S* pSliceMMZBuf)
{
    HI_S32 s32Ret = HI_FAILURE;
    ...
    s32Ret = HI_DRV_MMZ_AllocAndMap("VENC_SliceBuf", HI_NULL, BitBufSize, 64, &stMMZBuf);

    if (HI_SUCCESS == s32Ret)
    {
        VENC_DRV_EflGetMMZBufAddr(pSliceMMZBuf, &stMMZBuf);
    }
    else
    {
        HI_ERR_VENC("SliceBuf HI_DRV_VENC_AllocAndMap failed\n");
...
#if defined VENC_96MV200_CONFIG
    pEncPara->stHal.vlcst_para_set_en = 1;
    pEncPara->stHal.para_sprat_en = 1;
#endif
    /* make sps & pps & VOL stream */
...
HI_S32 VENC_DRV_EflCreateVenc( VeduEfl_EncPara_S **pEncHandle, VeduEfl_EncCfg_S *pEncCfg )
{
...
#ifdef VENC_96MV200_CONFIG
    if (VENC_DRV_EflAllocSliceBuf(&(pEncPara->stHal.SliceBuf)) != HI_SUCCESS)
    {
       goto error_slice;
    }
    memset(pEncPara->stHal.SliceBuf.pu8StartVirAddr, 0 , 4096);
    pEncPara->stHal.VEDU_PPS_ADDR = pEncPara->stHal.SliceBuf.u32StartPhyAddr;
#endif
    ...
    pEncPara->stHal.RegConfigMode = 1;

    if ((pEncPara->stHal.RegConfigMode) && (pEncCfg->Protocol != VEDU_JPGE))
    {
...
#endif
#ifdef VENC_96MV200_CONFIG
/*streambuffer按照slice分配16份给逻辑*/
    {
        HI_U32 i = 0;
        HI_U32 StreamAddr = 0;

        StreamAddr = BusBitBuf  + 64;

        for (i = 0; i < 16; i++)
        {
            pEncPara->stHal.VEDU_STRM_ADDR[i] = StreamAddr;
            pEncPara->stHal.VEDU_STRM_BUFLEN[i] = pEncPara->StreamMMZBuf.u32Size / 16;
        }
    }
    pEncPara->stHal.SliceBufAddr  = pEncPara->stHal.SliceBuf.u32StartPhyAddr;
    pEncPara->stHal.SliceBufSize  = pEncPara->stHal.SliceBuf.u32Size;
#endif
...
#ifdef VENC_96MV200_CONFIG
error_slice:
    VENC_DRV_EflReleaseMMZBuf(&pEncPara->stHal.SliceBuf);
#endif
error_1:
...
#endif
#if PARA_ADAPT_ENCODER
static HI_VOID VENC_DRV_EflInitDefaultRegTable(Vedu_EncPara_Table_S* pstEncParaTable, HI_U32 Protocol)
{
    HI_U32 i, j;
    HI_U32 p;
    ...
    for (i = 0; i < 2; i++ )
    {
        for (j = 0; j < 5; j++)
        {
            VeduEfl_IMGIMPROVE_SetDefaultAttr(&pstEncParaTable[i].ImgImproveCfg[j]);
            VeduEfl_QPG_SetDefaultAttr       (&pstEncParaTable[i].QpgCfg[j], Protocol);
            VeduEfl_PME_SetDefaultAttr       (&pstEncParaTable[i].PmeCfg[j]);

            if (VEDU_H264 == Protocol)
            {
                for (p =  0; p < 40; p++)
                {
                    pstEncParaTable[i].QpgCfg[j].lambda[p] = g_h264LambdaSsd[p];
                }

                for (p = 40; p < 80; p++)
                {
                    pstEncParaTable[i].QpgCfg[j].lambda[p] = g_h264LambdaSad[p - 40];
                }
            }
            else
            {
                for (p =  0; p < 40; p++)
                {
                    pstEncParaTable[i].QpgCfg[j].lambda[p] = g_h265LambdaSsd[p];
                }

                for (p = 40; p < 80; p++)
                {
                    pstEncParaTable[i].QpgCfg[j].lambda[p] = g_h265LambdaSad[p - 40];
                }
            }
        }
    }
...
static HI_VOID VENC_DRV_EflSetParaForPicQuality(Vedu_EncPara_Table_S* pstEncParaTable)
{
    int i, j;
    ...
    for ( i = 0; i < 2; i++)
    {
        ...
        {
            //norm region
            pstEncParaTable[i].ImgImproveCfg[j].norm_intra_cu16_rdcost_offset  = 0 ;
            pstEncParaTable[i].ImgImproveCfg[j].norm_inter_cu_rdcost_offset    = 0 ;
            pstEncParaTable[i].ImgImproveCfg[j].roundingMechanism              = 1 ;
            pstEncParaTable[i].ImgImproveCfg[j].norm16_tr1_denois_max_num      = 3 ;
            pstEncParaTable[i].ImgImproveCfg[j].norm16_coeff_protect_num       = 128 ;

            pstEncParaTable[i].ImgImproveCfg[j].skin_en  = 1; //skin
            pstEncParaTable[i].PmeCfg[j].skin_num        = 0x60;
            pstEncParaTable[i].PmeCfg[j].skin_v_min_thr  = 0x83 ; //130
            pstEncParaTable[i].PmeCfg[j].skin_v_max_thr  = 0xa0 ; //160
            pstEncParaTable[i].PmeCfg[j].skin_u_min_thr  = 0x64 ; //100
            pstEncParaTable[i].PmeCfg[j].skin_u_max_thr  = 0x7f ; //128
            pstEncParaTable[i].QpgCfg[j].skin_min_qp     = 10;
            pstEncParaTable[i].QpgCfg[j].skin_max_qp     = 35;
            pstEncParaTable[i].QpgCfg[j].skin_qp_delta   = 4;
            pstEncParaTable[i].ImgImproveCfg[j].skin_intra_cu16_rdcost_offset  = 0x0;
            pstEncParaTable[i].ImgImproveCfg[j].skin_inter_cu_rdcost_offset    = 0x000;
            pstEncParaTable[i].ImgImproveCfg[j].roundingSkinMechanism              = 1 ;
            pstEncParaTable[i].ImgImproveCfg[j].skin16_tr1_denois_max_num = 3;
            pstEncParaTable[i].ImgImproveCfg[j].skin16_coeff_protect_num  = 64 ;

            pstEncParaTable[i].ImgImproveCfg[j].highedge_en = 1; //stronge edge
            pstEncParaTable[i].PmeCfg[j].high_edge_cnt   = 3 ;
            pstEncParaTable[i].PmeCfg[j].high_edge_thr   = 20 ;
            pstEncParaTable[i].PmeCfg[j].interstrongedge_madi_thr     = 64;
            pstEncParaTable[i].PmeCfg[j].interdiff_max_min_madi_times = 4;
            pstEncParaTable[i].PmeCfg[j].interdiff_max_min_madi_abs   = 8 ;
            pstEncParaTable[i].QpgCfg[j].strong_edge_max_qp    = 48;
            pstEncParaTable[i].QpgCfg[j].stredge_min_qp    = 10;
            pstEncParaTable[i].QpgCfg[j].strong_edge_qp_delta  = 0;
            pstEncParaTable[i].ImgImproveCfg[j].hedge_intra_cu16_rdcost_offset  = 0x0;
            pstEncParaTable[i].ImgImproveCfg[j].hedge_inter_cu_rdcost_offset    = 0x000;
            pstEncParaTable[i].ImgImproveCfg[j].roundingEdgeMechanism          = 1 ;
            pstEncParaTable[i].ImgImproveCfg[j].hedge16_tr1_denois_max_num     = 4 ;
            pstEncParaTable[i].ImgImproveCfg[j].hedge16_coeff_protect_num      = 32  ;

            pstEncParaTable[i].QpgCfg[j].move_scene_en       = 1 ; //large move
            pstEncParaTable[i].QpgCfg[j].move_sad_en         = 0;
            pstEncParaTable[i].PmeCfg[j].move_sad_thr        = 384 ;
            pstEncParaTable[i].PmeCfg[j].move_scene_thr      = 3 ;
            pstEncParaTable[i].QpgCfg[j].large_move_max_qp   = 48;
            pstEncParaTable[i].QpgCfg[j].large_move_min_qp   = 10;
            pstEncParaTable[i].QpgCfg[j].large_move_qp_delta = 0;

            pstEncParaTable[i].QpgCfg[j].strong_edge_move_en = 1; //large move + stronge edge
            pstEncParaTable[i].QpgCfg[j].move_edge_max_qp    = 48;
            pstEncParaTable[i].QpgCfg[j].stredge_move_min_qp    = 10;
            pstEncParaTable[i].QpgCfg[j].strong_edge_move_qp_delta  = 0;
            pstEncParaTable[i].ImgImproveCfg[j].strmov_intra_cu16_rdcost_offset  = 0x0;
            pstEncParaTable[i].ImgImproveCfg[j].strmov_inter_cu_rdcost_offset    = 0x000;
            pstEncParaTable[i].ImgImproveCfg[j].roundingedgemovmechanism           = 1;
            pstEncParaTable[i].ImgImproveCfg[j].edgemov16_tr1_denois_max_num     = 4 ;
            pstEncParaTable[i].ImgImproveCfg[j].edgemov16_coeff_protect_num      = 32;

            pstEncParaTable[i].ImgImproveCfg[j].static_en = 1;    //static region
            pstEncParaTable[i].PmeCfg[j].still_scene_thr  = 2 ;
            pstEncParaTable[i].ImgImproveCfg[j].roundingStillMechanism         = 1 ;
            pstEncParaTable[i].ImgImproveCfg[j].static16_tr1_denois_max_num    = 4 ;
            pstEncParaTable[i].ImgImproveCfg[j].static16_coeff_protect_num     = 16  ;

            pstEncParaTable[i].QpgCfg[j].rc_low_luma_en      = 1; //low luma region
            pstEncParaTable[i].PmeCfg[j].low_luma_thr        = 0;
            pstEncParaTable[i].PmeCfg[j].low_luma_madi_thr   = 5;
            pstEncParaTable[i].PmeCfg[j].pme_high_luma_thr   = 60;
            pstEncParaTable[i].QpgCfg[j].lowluma_max_qp      = 44;
            pstEncParaTable[i].QpgCfg[j].lowluma_min_qp      = 10;
#ifdef VENC_98MV200_CONFIG
            pstEncParaTable[i].QpgCfg[j].low_luma_qp_delta   = 2;
#endif
        }
    }
    ...
    for ( i = 0; i < 2; i++)
    {
        //startQp in [0,25]
        j = 0;
        pstEncParaTable[i].ImgImproveCfg[j].norm16_tr1_denois_max_num = 1 ;

        pstEncParaTable[i].ImgImproveCfg[j].skin16_coeff_protect_num = 128 ;
        pstEncParaTable[i].ImgImproveCfg[j].hedge16_coeff_protect_num = 128 ;
        pstEncParaTable[i].ImgImproveCfg[j].edgemov16_coeff_protect_num = 128 ;
        pstEncParaTable[i].QpgCfg[j].rc_low_luma_en      = 0; //low luma region
        pstEncParaTable[i].ImgImproveCfg[j].static_en    = 0;    //static region
        pstEncParaTable[i].QpgCfg[j].move_scene_en       = 0 ; //large move
        pstEncParaTable[i].ImgImproveCfg[j].highedge_en  = 0; //stronge edge

        //startQp in (25,30]
        j = 1;
        pstEncParaTable[i].QpgCfg[j].move_scene_en = 0 ; //large move
        pstEncParaTable[i].ImgImproveCfg[j].skin16_coeff_protect_num = 64 ;
        pstEncParaTable[i].ImgImproveCfg[j].hedge16_coeff_protect_num = 64 ;
        pstEncParaTable[i].ImgImproveCfg[j].edgemov16_coeff_protect_num = 64 ;
        pstEncParaTable[i].QpgCfg[j].skin_qp_delta   = 6;
        ...
        pstEncParaTable[i].ImgImproveCfg[j].hedge16_coeff_protect_num = 64 ;
        pstEncParaTable[i].ImgImproveCfg[j].edgemov16_coeff_protect_num = 64 ;
        pstEncParaTable[i].QpgCfg[j].skin_qp_delta = 5;

        //startQp in (42,51]
        j = 4;
        pstEncParaTable[i].ImgImproveCfg[j].skin_intra_cu16_rdcost_offset = 0x1;
        pstEncParaTable[i].ImgImproveCfg[j].skin_inter_cu_rdcost_offset = 0x020;
        pstEncParaTable[i].ImgImproveCfg[j].skin_fme_cu16_rdcost_offset = 0x0;
        pstEncParaTable[i].ImgImproveCfg[j].skin_mrg_cu16_rdcost_offset = 0x0;

        pstEncParaTable[i].PmeCfg[j].high_edge_cnt = 2 ;
        pstEncParaTable[i].PmeCfg[j].high_edge_thr = 15 ;
        pstEncParaTable[i].PmeCfg[j].interstrongedge_madi_thr = 64;
        pstEncParaTable[i].PmeCfg[j].interdiff_max_min_madi_times = 2;
        pstEncParaTable[i].PmeCfg[j].interdiff_max_min_madi_abs = 4 ;

        if (i == 0)
        {
            pstEncParaTable[i].ImgImproveCfg[j].hedge_intra_cu16_rdcost_offset = 0x4;
        }
        else
        {
            pstEncParaTable[i].ImgImproveCfg[j].hedge_intra_cu16_rdcost_offset = 0x3;
        }

        pstEncParaTable[i].ImgImproveCfg[j].hedge_inter_cu_rdcost_offset = 0x000;
        pstEncParaTable[i].ImgImproveCfg[j].hedge16_tr1_denois_max_num = 3 ;
        pstEncParaTable[i].ImgImproveCfg[j].hedge16_coeff_protect_num = 32  ;
        pstEncParaTable[i].QpgCfg[j].move_sad_en = 1;
        pstEncParaTable[i].PmeCfg[j].move_sad_thr = 256 ;

        if (i == 0)
        {
            pstEncParaTable[i].ImgImproveCfg[j].strmov_intra_cu16_rdcost_offset = 0x4;
        }
        else
        {
            pstEncParaTable[i].ImgImproveCfg[j].strmov_intra_cu16_rdcost_offset = 0x3;
        }

        pstEncParaTable[i].ImgImproveCfg[j].strmov_inter_cu_rdcost_offset   = 0x022;
        pstEncParaTable[i].ImgImproveCfg[j].strmov_fme_cu16_rdcost_offset    = 3;
        pstEncParaTable[i].ImgImproveCfg[j].strmov_mrg_cu16_rdcost_offset    = 3;

        pstEncParaTable[i].ImgImproveCfg[j].edgemov16_tr1_denois_max_num     = 3 ;
        pstEncParaTable[i].ImgImproveCfg[j].edgemov16_coeff_protect_num      = 32;
...
#if PARA_ADAPT_ENCODER
    VENC_DRV_EflInitDefaultRegTable(pEncPara->stEncParaTable, pEncPara->Protocol);
    VENC_DRV_EflSetParaForPicQuality(pEncPara->stEncParaTable);
#endif
...
#if ((defined VENC_98MV200_CONFIG)|(defined VENC_96MV200_CONFIG))             //for lowdelay
...
#if (defined HI_SMMU_SUPPORT) && ((defined VENC_98MV200_CONFIG)|(defined VENC_96MV200_CONFIG))
    Venc_Smmu_ISR(pEncPara);
#endif

#if defined VENC_96MV200_CONFIG
    if (pAllReg->VEDU_FUNC_REGS.FUNC_VCPI_RAWINT.bits.vcpi_rint_vedu_timeout) //超时软复位
#elif defined VENC_98MV200_CONFIG
...
#if (defined VENC_96MV200_CONFIG)
    pAllReg->VEDU_REGS.VEDU_VCPI_INTCLR.u32 = 0x08000000;  //清中断
#elif (defined VENC_98MV200_CONFIG)
...
#if ((defined VENC_3716CV200_CONFIG)|(defined VENC_S5V100_CONFIG)|(defined VENC_98M_CONFIG)| (defined VENC_98CV200_CONFIG) | (defined VENC_98MV200_CONFIG))
#if (defined VENC_98MV200_CONFIG)
...
#if (defined VENC_96MV200_CONFIG)
    if (pAllReg->VEDU_FUNC_REGS.FUNC_VCPI_RAWINT.bits.vcpi_rint_ve_eop ) //帧级中断
#elif (defined VENC_98MV200_CONFIG)
...
#endif
#if (defined VENC_96MV200_CONFIG)
        pAllReg->VEDU_REGS.VEDU_VCPI_INTCLR.u32 = 0xFFFFFFFF;
#elif (defined VENC_98MV200_CONFIG)
           ...
           venc_stream_addr = (HI_VOID*)(StreamBuf.bufferaddr_Phy+StreamBuf.vir2phy_offset);
            do
            {
                if ( VENC_DRV_EflGetStreamLen(EncHandle) > 0)
                {
                    ...
                    if (StreamBuf.buffer_size >= (Nalu.SlcLen[0] + Nalu.SlcLen[1]))
                    {
                        if (Nalu.SlcLen[0] > 0)
                        {
