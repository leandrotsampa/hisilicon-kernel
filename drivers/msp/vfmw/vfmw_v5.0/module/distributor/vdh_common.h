...
typedef enum
{
    ...
    WAKE_UP_USER_SCD_TASK,
    WAKE_UP_USER_MFDE_TASK,
    WAKE_UP_SCD_IDLE,
    WAKE_UP_MFDE_IDLE,
    WAKE_UP_EXIT,
}WAKE_UP_TYPE_E;
...
typedef struct
{
    ...
    WAKE_UP_TYPE_E   UserWakeUp;
    TASK_ARRAY_S     UserScdArray[SCD_MODULE_NUM];
    TASK_ARRAY_S     UserMfdeArray[MFDE_MODULE_NUM];
} VDH_COMMON_CTX_S;
