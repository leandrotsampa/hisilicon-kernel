...
typedef enum
{
    ADSP_SYSCOM_CMD_START = 0, /**<Stop*/
    ADSP_SYSCOM_CMD_STOP,     /**<Start*/
...
typedef enum
{
    ADSP_AOE_CMD_START = 0, /**<Stop*/
    ADSP_AOE_CMD_STOP,	   /**<Start*/
    ADSP_AOE_CMD_BUTT
} ADSP_AOESYS_CMD_E;
...
typedef enum
{
    AOE_FORMAT_LPCM = 0,	   /**<linear pcm*/
    AOE_FORMAT_IEC61937 = 1,	   /**<iec61937 raw data*/
    AOE_FORMAT_IEC61937_COMP = 2,  /**<compressed iec61937 raw data*/
    AOE_FORMAT_BUTT = 3
} AOE_DATA_FORMAT_E;
...
typedef enum
{
    ...
    AOE_AIP_TYPE_PCM_SLAVE,    /**2.0 Normal Pcm for slave track*/
    AOE_AIP_TYPE_PCM_DMX,      /**downmixer pcm for master track*/
    AOE_AIP_TYPE_PCM_MC,       /**multi chn pcm for master track*/
    AOE_AIP_TYPE_PCM_ASSOC,    /**assoc chn pcm for master track only when double decoder*/
    AOE_AIP_TYPE_PCM_BUTT
} AOE_AIP_TYPE_PCM_E;

typedef enum
{
    AOE_AIP_CMD_START = 0, /**<Stop*/
    AOE_AIP_CMD_STOP,	 /**<Start*/
    AOE_AIP_CMD_PAUSE,
    AOE_AIP_CMD_FLUSH,
...
typedef enum
{
    AOE_ENGINE_CMD_START = 0, /**<Stop*/
    AOE_ENGINE_CMD_STOP,     /**<Start*/
...
typedef enum
{
    AOE_AOP_CMD_START = 0, /**<Stop*/
    AOE_AOP_CMD_STOP, /**<Start*/
