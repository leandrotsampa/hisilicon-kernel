...
typedef struct tagCHAN_FRAME_BUFFER_S
{
    ...
    HI_BOOL		       bAvailable;//��ʾ�ǲ��ǿ������ø�vfmw�����е�֡��������ø�vfmw
    HI_BOOL		       bConfigured;
...
/*��¼vfmw�ϱ�����Ҫ������ڴ���Ϣ��С������֡����Ϣ��pmv��Ϣ��hdr��metadata��Ϣ*/
typedef struct tagVFMW_REPORT_FRAME_BUFFER_INFO_S
{
    UINT32  u32OneFrameTotalSize;/*�������ݵ��ܴ�С*/
    UINT32  u32ImageSize;/*֡����Ϣ��С*/
    UINT32  u32ImageNum;/*��Ҫ�����֡�����*/
    UINT32  u32PmvSize;/*pmv��Ϣ��С*/
    UINT32  u32PmvNum;/*��Ҫ�����pmv����*/
    UINT32  u32HdrMetadataSize;/*hdr metadata��Ϣ��С*/
    UINT32  u32AllocFrameOnly;/*����Ҫ����֡��*/
    UINT32  u32ImageSizeOnly;
    UINT32  u32ImageNumOnly;
} VFMW_REPORT_FRAME_BUFFER_INFO_S;

/*��¼�Ѿ����ø�vfmw���ڴ�ڵ�ĸ���������֡�棬pmv�ڴ棬hdr metadata�ڴ�*/
typedef struct tagVFMW_CONFIGURED_BUFFER_NUM_S
{
    UINT32  u32ImageNum;/*�Ѿ����ø�vfmw��֡�����*/
...
typedef struct tagVDEC_CHANNEL_S
{
    ...
    HI_U32		    u32BitRate;
    HI_U32		    u32Profile;
    HI_U32		    u32LastLumaBitdepth;     // proc 10bit��Ϣ
    HI_U32		    u32LastChromaBitdepth;   // proc 10bit��Ϣ
    HI_U32		    u32Level;
    ...
    VFMW_REPORT_FRAME_BUFFER_INFO_S stVFMWReportFrameInfo;//��¼vfmw�ϱ�����Ҫvdec�����֡���С�͸�����pmv��hdr metadata�ֿ��ϱ���
    VFMW_CONFIGURED_BUFFER_NUM_S    stVFMWConfiguredBufferNum;//��¼�Ѿ����ø�vfmw���ڴ�(֡��,pmv,hdr metadata)�ĸ�����ͨ������Ϣ��vfmw�ϱ�����Ϣ�Աȣ������㻹��Ҫ���õĶ�Ӧ���ڴ�ĸ���
    HI_BOOL			    bDPBFullCtrl;
    VDEC_PROBE_STREAM_INFO_S	    stProbeStreamInfo;

    CHAN_FRAME_BUFFER_S stFrameBufferRecord[VDEC_MAX_BUFFER_RECORD];//����֡��ڵ㣬����Ԥ����Ͷ�̬����
...
typedef enum
{
    VDEC_VPSS_BYPASSMODE_AUTO = 0,    /*͸�������VPSS����*/
    VDEC_VPSS_BYPASSMODE_ENABLE,      /*PORT͸��ʹ��*/
    VDEC_VPSS_BYPASSMODE_DISABLE,     /*PORT��͸����ֹ*/
    VDEC_VPSS_BYPASSMODE_BUTT	      /*״̬����*/
