...
HI_S32 TdeHalInit(HI_U32 u32BaseAddr)
{
	...
	#ifndef CONFIG_TDE_USE_SDK_CRG_ENABLE
     /* set limit of clock and div *//*CNcomment:  ����ʱ�����ޡ�ʱ�ӷ�Ƶ */
...
HI_VOID TdeHalCtlReset(HI_VOID)
{
    ...
    /* write TDE_REQ_TH*//*CNcomment: д�������޿��ƼĴ���*/
    TDE_WRITE_REG(s_pu32BaseVirAddr, TDE_REQ_TH, 0x01fef7cf);

    /* write TDE_BUS_LIMITER*//*CNcomment: д�����������ƼĴ���*/
...
HI_VOID TdeHalNodeEnableAlphaRop(TDE_HWNode_S *pHWNode)
{
    ...
    unAlphaBlend.stBits.u32AlphaRopEn = HI_TRUE;/*enable alpha rop operation*//*CNcomment: ʹ��Alpha Rop����*/
...
TDE_NODE_SUBM_TYPE_E enNodeType)
{
	...
	{
	    unRsz.stBits.u32VfRingEn = pstFilterOpt->bVRing;  /*enable middle Flicker*//*CNcomment: ʹ����ֵ�˲�*/
	   ...
	   /*set plumb offset*//*CNcomment:  ���ô�ֱƫ�� */
	    u32Sign = ((HI_U32)pstFilterOpt->s32VOffset)>> 31; /*get symbol*//*CNcomment: ��ȡ����*/
	...
	if (TDE_DRV_FILTER_NONE != pstFilterOpt->enFilterMode)
	{
	    unRsz.stBits.u32HfRingEn = pstFilterOpt->bHRing; /*enable middle Flicker*//*CNcomment: ʹ����ֵ�˲�*/
	    ...
	    u32Sign = ((HI_U32)pstFilterOpt->s32HOffset) >> 31; /*get symbol*//*CNcomment: ��ȡ����*/
    ...
    unRsz.stBits.u32CoefSym = pstFilterOpt->bCoefSym;/*Flicker parameter*//*CNcomment:�Գ��˲�ϵ��*/
    pHWNode->u32TDE_2D_RSZ = unRsz.u32All;
    if (TDE_NODE_SUBM_PARENT == enNodeType)
    {
	pHWNode->u32TDE_INS = unIns.u32All;
...
STATIC INLINE HI_VOID TdeHalInitQueue(HI_VOID)
{
    ...
    /*enable Aq list*//*CNcomment: ʹ��Aq���� */
    unAqCtrl.stBits.u32AqEn = 1;/*hardware disable*//*CNcomment: Ӳ����ʱ����*/

    /*set Aq operation mode*//*CNcomment:  ����Aq����ģʽ */
    unAqCtrl.stBits.u32AqOperMode = TDE_AQ_CTRL_COMP_LINE;
    TDE_WRITE_REG(s_pu32BaseVirAddr, TDE_AQ_CTRL, unAqCtrl.u32All);
