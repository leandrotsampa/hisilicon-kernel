...
/**����:  ֻ����OMXͨ·��vpss bypass��������ⲿ����FTBʱomxvdec�ڲ���VFMW��֡	  **/
/**�޸���:l00228308								  **/
/***********************************************************************************/
...
/**����	   :  ֻ����OMXͨ·���жϸ�֡�Ƿ���special֡				    **/
/**����˵��:									    **/
/**TargetPhyAddr    : �Ա�Ŀ��������ַ/Smmu��ַ					    **/
/**pIndex:	      ����ǿգ��򷵻ض�Ӧ�ҵ���OccupiedFrm������ID��		    **/
/**		      ���Ϊ�գ�����ζ�����治��Ҫ����ID�����ԣ�������		    **/
/**�޸���:l00228308								    **/
/*************************************************************************************/
...
/**����	   :  ֻ����OMXͨ·���жϵ�ǰ�Ƿ��п��Ա��ͷŵ�special֡		    **/
/**����˵��:									    **/
/**pList   : ȫ��special֡�б�ָ��						    **/
/**pIndex:   �ǿգ����ض�Ӧ�ҵ���OccupiedFrm������ID��				    **/
/**�޸���:l00228308								    **/
/*************************************************************************************/
...
/**����:  ֻ����OMXͨ·����ȡVPSS �Ƿ� bypass ����Ϣ								   **/
/* ����˵��:													   **/
/* pchan	   : ͨ����Ϣ������										   **/
/* chan_cfg	   : �������е�cfg_width��cfg_height								   **/
/**�޸���:l00228308												   **/
/********************************************************************************************************************/
