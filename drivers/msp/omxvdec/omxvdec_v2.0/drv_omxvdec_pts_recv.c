...
static HI_VOID OMX_PTSREC_HandleValidSrcPTS(HI_HANDLE hHandle, IMAGE *pstImage)
{
    HI_U32 u32NumPass = 0;
    HI_U32 u32PtsPass = 0;
...
static HI_U32 OMX_PTSREC_GetFrameTime_User(PTSREC_CHAN_INFO_S *pstPtsInfo, IMAGE *pstImage)
{
...
static HI_U32 OMX_PTSREC_GetFrameTime_Other(PTSREC_CHAN_INFO_S *pstPtsInfo, IMAGE *pstImage)
{
    HI_U32 u32FrameTime = HI_INVALID_TIME;
...
static HI_VOID OMX_PTSREC_HandleInValidSrcPTS(HI_HANDLE hHandle, IMAGE *pstImage)
{
    HI_U32 u32NumPass = 0;
    HI_U32 u32FrameTime = HI_INVALID_TIME;
    HI_U32 u32Pts;
	...
	{
	    u32FrameTime = OMX_PTSREC_GetFrameTime_User(pstPtsInfo, pstImage);
	}
	else /* HI_UNF_AVPLAY_FRMRATE_TYPE_USER_PTS ... */
	{
	    u32FrameTime = OMX_PTSREC_GetFrameTime_Other(pstPtsInfo, pstImage);
	}
...
HI_U32 OMX_PTSREC_CalcStamp(HI_HANDLE hHandle, IMAGE *pstImage)
{
    ...
    {
	OMX_PTSREC_HandleValidSrcPTS(hHandle, pstImage);
    }
    else
    {
	OMX_PTSREC_HandleInValidSrcPTS(hHandle, pstImage);
    }
