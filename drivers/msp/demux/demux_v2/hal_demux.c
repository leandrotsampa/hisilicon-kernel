...
/*demux �ж��ڼĴ����������ھ��������ܻ�����Ī������Ĵ���review ���мĴ�����ͳһ�޸�
���ⵥ��: DTS2013082001104 */
...
HI_VOID DmxHalIPPortGetDescInfo(Dmx_Set_S *DmxSet, HI_U32 RawPortId, DMX_Proc_RamPort_DescInfo_S *DescInfo)
{
    ...
    DescWNodeAddr	     = DescInfo->DescPhyAddr + DescInfo->DescWPtr * 16 ; /*ÿ�������ӽڵ�size �� 16BYTE*/
    DescRNodeAddr	     = DescInfo->DescPhyAddr + DescInfo->DescRPtr * 16 ; /*ÿ�������ӽڵ�size �� 16BYTE*/
...
#if defined(DMX_SECURE_CHANNEL_SUPPORT)
