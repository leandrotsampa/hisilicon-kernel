...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    vdac_finetuning       : 6   ; /* [21..16]  */
        unsigned int    reserved_1            : 7   ; /* [28..22]  */
...
typedef struct
{
    ...
    volatile unsigned int           reserved_3[119]                     ; /* 0x124~0x2fc */
    ...
    volatile unsigned int           reserved_137[80]                     ; /* 0xccc0~0xcdfc */
    ...
    volatile unsigned int           reserved_141[328]                     ; /* 0xcee0~0xd3fc */
