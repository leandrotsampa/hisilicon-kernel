...
typedef struct hiSYNC_PCR_INFO_S
{
    ...
    HI_BOOL		       PcrLoopBack;
    HI_U32		       PcrGradient;	    /* gradient of pcr and system time*//**<CNcomment: PCR��ϵͳʱ�����б��(*100)*/
...
{
    SYNC_BUF_STATE_EMPTY = 0,	/**<The buffer is idle.*//**<CNcomment: ����������*/
    SYNC_BUF_STATE_LOW,		/**<The buffer usage is too low.*//**<CNcomment: ������ռ���ʹ���*/
    SYNC_BUF_STATE_NORMAL,	/**<The buffer works normally.*//**<CNcomment: ������ʹ������*/
    SYNC_BUF_STATE_HIGH,	/**<The buffer usage is too high.*//**<CNcomment: ������ռ���ʹ���*/
    SYNC_BUF_STATE_FULL,	/**<The buffer is full.*//**<CNcomment: ����������*/
...
typedef struct hiPRE_SYNC_INFO_S
{
