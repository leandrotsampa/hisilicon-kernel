...
typedef struct hiTUNER_TER_SCAN_PARA_S
{
	...
	HI_UNF_TUNER_TER_TPINFO_S enTpInfo;		/**<result of tp array*/		/**<CNcomment:ɨ��Ƶ����������ʽ�洢*/
...
{
    HI_U32 u32Frequency;	    /**<frequency kHz*/				   /**<CNcomment:Ƶ�ʣ���λkHz*/
    HI_U32 u32SymbolRate;	    /**<symbolrate kBaud*/			   /**<CNcomment:�����ʣ���λkBaud*/
