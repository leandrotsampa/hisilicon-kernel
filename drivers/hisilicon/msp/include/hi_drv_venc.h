...
#define VENC_MSG_RESP_INPUT_DONE	(VENC_MSG_RESP_BASE + 0x7)	    //��֡���Ի�
#define VENC_MSG_RESP_OUTPUT_DONE	(VENC_MSG_RESP_BASE + 0x8)	    //�Ѿ�����?
...
{
    HI_VIRT_ADDR_T	    VirAddr;	    /**<Stream virtual address*/ /**<CNcomment: ���������ַ*/
...
{
    HI_U32 status_code;		 //��¼�����ķ���ֵ(success/failure)
    HI_U32 msgcode;		 //�Զ����������Ϣ����ֵ�������ڴ˴�
    venc_user_buf buf;	   //
    HI_U32 msgdatasize;
} venc_msginfo;
