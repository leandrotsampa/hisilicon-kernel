...
{
    HI_DRV_SAMPLE_TYPE_UNKNOWN,			 /**<Unknown*/ /**<CNcomment: δ֪������ʽ*/
    HI_DRV_SAMPLE_TYPE_PROGRESSIVE,		 /**<Progressive*/ /**<CNcomment: ������ʽΪ����*/
    HI_DRV_SAMPLE_TYPE_INTERLACE,		 /**<Interlaced*/ /**<CNcomment: ������ʽΪ����*/
