...
#include "jpeg_drv_dec.h"
	...
	/** CNcomment:�ж��ڴ����ͣ���mmu����mmz CNend */
	typedef enum hiJPEG_MEMTYPE_E
	{
	    JPEG_DRV_STREAM_MEM_MMU_TYPE	    = 0X1,    /**< 0bit �����ڴ�ΪMMU����	       */
	    JPEG_DRV_YOUTPUT_MEM_MMU_TYPE	    = 0X2,    /**< 1bit Y��������ڴ�ΪMMU����	       */
	    JPEG_DRV_UVOUTPUT_MEM_MMU_TYPE	    = 0X4,    /**< 2bit UV��������ڴ�ΪMMU����	       */
	    JPEG_DRV_XRGBSAMPLE0_READ_MEM_MMU_TYPE  = 0X8,    /**< RGB�����Ҫ���ϲ���0buffer������    */
	    JPEG_DRV_XRGBSAMPLE1_READ_MEM_MMU_TYPE  = 0X10,   /**< RGB�����Ҫ���ϲ���1buffer������    */
	    JPEG_DRV_XRGBSAMPLE0_WRITE_MEM_MMU_TYPE = 0X20,   /**< RGB�����Ҫ���ϲ���0bufferд����    */
	    JPEG_DRV_XRGBSAMPLE1_WRITE_MEM_MMU_TYPE = 0X40,   /**< RGB�����Ҫ���ϲ���1bufferд����    */
	    JPEG_DRV_XRGBOUTPUT_MEM_MMU_TYPE	    = 0X80,   /**< 7bitRGB����ڴ�ΪMMU����	       */
