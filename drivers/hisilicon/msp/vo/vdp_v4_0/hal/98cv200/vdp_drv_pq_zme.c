...
HI_S32 VDP_GetVdpZmeCoef(HI_PQ_ZME_COEF_RATIO_E enCoefRatio, HI_PQ_ZME_COEF_TYPE_E enCoefType, HI_PQ_ZME_TAP_E enZmeTap, HI_S16* ps16Coef)
{
	...
	if (HI_PQ_ZME_TAP_5T32P == enZmeTap)
	{
	    ...
	    if (enCoefRatio == HI_PQ_ZME_COEF_1)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_1][VDP_ZOOM_TAP_5LV], sizeof(HI_S32) * 5 * 18);

	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_E1)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_5LV], sizeof(HI_S32) * 5 * 18);
	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_075)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_5LV], sizeof(HI_S32) * 5 * 18);
	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_05)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_5LV], sizeof(HI_S32) * 5 * 18);
	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_033)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_5LV], sizeof(HI_S32) * 6 * 18);
	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_025)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_5LV], sizeof(HI_S32) * 5 * 18);
	    }
	}
	else
	{
	...
	if (HI_PQ_ZME_TAP_3T32P == enZmeTap)
	{
	    if (enCoefRatio == HI_PQ_ZME_COEF_1)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_1][VDP_ZOOM_TAP_3CV], sizeof(HI_S32) * 3 * 18);

	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_E1)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_EQU_1][VDP_ZOOM_TAP_3CV], sizeof(HI_S32) * 3 * 18);
	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_075)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_075][VDP_ZOOM_TAP_3CV], sizeof(HI_S32) * 3 * 18);
	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_05)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_05][VDP_ZOOM_TAP_3CV], sizeof(HI_S32) * 3 * 18);

	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_033)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_033][VDP_ZOOM_TAP_3CV], sizeof(HI_S32) * 3 * 18);
	    }
	    else if (enCoefRatio == HI_PQ_ZME_COEF_025)
	    {
		memcpy((HI_VOID*)ps16Coef, (HI_VOID*)g_pOrgZoomCoef[VDP_ZOOM_COEF_025][VDP_ZOOM_TAP_3CV], sizeof(HI_S32) * 3 * 18);
	    }
	}
	else
	{
