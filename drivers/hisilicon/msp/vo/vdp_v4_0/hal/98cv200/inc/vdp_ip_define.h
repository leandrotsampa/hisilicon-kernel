...
typedef struct tagVDP_DCI_PARA_S
{
	...
	HI_S32	s32OutHStart;	  //12 bit, DCI��������
...
typedef struct tagVDP_DISP_DIMMING_CFG_S
{
	...
	int m_bOutputEN;
	int m_bAutoSettingEN;			//�Զ���, 1/zonesize,  1/height;
	int m_LEDNUMH;					//horz zone number
	int m_LEDNUMV;					//vert zone number
	int m_BYPASS_LCD;				//��� = 1, ���ͼ��ֵ .
	int m_BYPASS_LED;				//���=1 ������ֵ.
	int m_DISABLE_2D;				//���=1 ������ֵ.
	int m_SEL_UHD;				    //���=1 ������ֵ.
	int m_MODE_INIT_LED;			//0Dʱ��ʼ�������Ľ���blengding
	int m_LEDDRIVE_MAX;
	int m_DIV_HEIGHT;				//1/height
	int m_DIV_WIDTH;				//1/width
	int m_DIV_SEGHEIGHT;			//1/zonesize
	int m_DIV_SEGWIDTH;				//1/zonesize
	int m_LEDSEGH;					//ÿ��zonesize
	int m_LEDSEGV;					//ÿ��zonesize
	int m_COL_STARTLED;				//��һ��zone������λ��.
	int m_ROW_STARTLED;				//��һ��zone������λ��.
	int m_LEDDSTH;					//����zone�����ĵ����.	 overlap   zoneSize ������overlap
	int m_LEDDSTV;					//v����zone�����ĵ����.
	int m_LPF_MODE;
	int m_GAIN_LED2D;				//4095 �������ÿ��zone LED ֵ��blend		   �̶�
	int m_GAIN_BLDMAX2D;			//�����ÿ��zone LEDֵ ��ÿ��zone�����ֵ����blending  �̶�
	int m_BITS_B_HIST;
	int m_BITS_W_HIST;
	int m_THR_MD0;
	int m_THR_MD2;
	...
	int m_GAIN_LED0D;				//��4095 blending������
	int m_GAIN_LED0D_TF;			//ʱ�����˲�
	int m_SC0D_SW;					// scene change����ȥ��������
	int m_LED0D_SW;					//scene change����ȥ��������
	int m_LED0D_CORE_LW;
	int m_LED0D_CORE_MD;
	int m_LED0D_CORE_HG;
	int m_LED0D_X0_LW;
