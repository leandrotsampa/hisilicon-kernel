...
static void nano_phy_config_0(struct hiclk_hw *clk)
{
	...
	*/
	...
	writel(0x203000, clk->peri_crg_base + USB3_NANOPHY_REGBASE);
	udelay(20);
	writel(0x1203000, clk->peri_crg_base + USB3_NANOPHY_REGBASE);
	udelay(20);
	writel(0x203000, clk->peri_crg_base + USB3_NANOPHY_REGBASE);
	udelay(20);
	writel(0x0, clk->peri_crg_base + USB3_NANOPHY_REGBASE);
	udelay(20);
}
/******************************************************************************/
