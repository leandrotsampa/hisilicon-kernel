...
typedef struct hiMPI_DMX_BUF_STATUS_S
{
    ...
    HI_U32 u32UsedSize; /* buffer used size *//*CNcomment:��������ʹ�ô�С */
    HI_U32 u32BufRptr;	/*buffer read pointer *//*CNcomment:��������ָ��*/
    HI_U32 u32BufWptr;/*buffer written pointer *//*CNcomment:������дָ��*/
...
/* Channel */
/*Buffer for video and audio channel should be attached,it's meaningless to config when apply them *//*CNcomment: ����Ƶͨ����buffer��Ҫ�󶨣�������ʱ����û������*/
...
/*Only video and audio channel are enable to attach PES Buffer *//*CNcomment:	ֻ������Ƶͨ�������󶨺ͽ��PES Buffer*/
HI_S32 HI_MPI_DMX_GetPESBufferStatus(HI_HANDLE hChannel, HI_MPI_DMX_BUF_STATUS_S *pBufStat);

/*Be used to send stream to user status decoder *//*CNcomment:	 ���ڸ��û�̬����Ƶ����������*/
...
/* CNcomment:DMX_IDX_DATA_S �и���Ա��˳���ܸı䣬������Ӳ���涨��˳�򱣳�һ�� */
typedef struct hiDMX_IDX_DATA_S
{
    ...
    HI_U32 u32SrcClk;
    HI_U32 u32BackPacetNum;/*Back package number*//* CNcomment:���˰�����*/
} DMX_IDX_DATA_S;
