...
#else
#define HI_CHIP_ID_WORD_ADDR       (0xf8ab0060)
#endif
...
HI_S32 HI_DRV_SYS_Get64DieID(HI_U64 *pu64dieid)
{
    ...
    kSys_lock();
    u32CrgValueOri = HI_REG_ReadBits((HI_U8 *)pOtpVirAddr+0x1E4, 0xFFFFFFFF);
    HI_REG_WRITE((HI_U8 *)pOtpVirAddr+0x1E4, u32CrgValueOri | 0x1);  //just bit0 valid in this register, reset otp
    HI_REG_WRITE((HI_U8 *)pOtpVirAddr+0x1E4, u32CrgValueOri & ~0x1);  //just bit0 valid in this register, resume reset otp
