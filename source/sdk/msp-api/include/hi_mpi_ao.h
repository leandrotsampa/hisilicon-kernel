...
typedef enum hiHI_MPI_RENDER_TRACK_TYPE_E
{
    HI_MPI_RENDER_TRACK_TYPE_MAIN,
    HI_MPI_RENDER_TRACK_TYPE_SYS,
    HI_MPI_RENDER_TRACK_TYPE_TTS,
    HI_MPI_RENDER_TRACK_TYPE_BUTT
} HI_MPI_RENDER_TRACK_TYPE_E;
...
{
    HI_MPI_RENDER_TRACK_TYPE_E enType;
    HI_U32 u32Channel;
...
HI_S32	 HI_MPI_AO_Track_SendStream(HI_HANDLE hTrack, HI_MPI_AO_BUFID_E enBufId, const HI_UNF_STREAM_BUF_S* pstStream, HI_U32 u32PtsMs);
