...
Author           :
Created          : 2016/08/13
Description      : Describes adp file. CNcomment:API��ƽ̨���� CNend\n
Function List    :
...
/**
\brief get stride from input width. CNcomment:����ͼƬ�Ŀ������ȡstride��С CNend
\attention \n
