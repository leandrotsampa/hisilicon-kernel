...
static HI_S32 Hdmi_InfoFrameDrv2User(HI_UNF_HDMI_INFOFRAME_S *pstDestInfoFrame, DRV_HDMI_INFOFRAME_S *pstSrcInfoFrame)
{
    ...
    switch (pstSrcInfoFrame->enInfoFrameId)
    {
        case HDMI_INFOFRAME_TYPE_AVI:
        {
            ...
            {
                pstUnfAVIInfoFrame->enColorimetry = pstDrvAVIInfoFrame->extended_colorimetry \
                    + HDMI_COLORIMETRY_EXTENDED + 1;
            }
            else
            {
...
static HDMI_VIDEO_TIMING_E Hdmi_Fmt2HdmiTiming(HI_U32 u32Fmt)
{
    ...
    switch (u32Fmt)
    {
        ...
        case HI_DRV_DISP_FMT_VESA_800X600_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_800X600_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1024X768_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1024X768_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1280X800_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1280X800_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1280X1024_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1280X1024_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1360X768_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1360X768_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1440X900_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1440X900_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1440X900_60_RB:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1440X900_60_RB;
            break;
        case HI_DRV_DISP_FMT_VESA_1400X1050_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1440X1050_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1600X1200_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1600X1200_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1680X1050_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1680X1050_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1680X1050_60_RB:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1680X1050_60_RB;
            break;
        case HI_DRV_DISP_FMT_VESA_1920X1200_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1920X1200_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1920X1440_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_1920X1440_60;
            break;
        case HI_DRV_DISP_FMT_VESA_2560X1600_60_RB:
            VideoTimingMode = HDMI_VIDEO_TIMING_VESA_2560x1600_60;
            break;
        // USER DEFINE
        case HI_DRV_DISP_FMT_VESA_1280X720_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_USER_1280X720_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1366X768_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_USER_1366X768_60;
            break;
        case HI_DRV_DISP_FMT_VESA_1600X900_60_RB:
            VideoTimingMode = HDMI_VIDEO_TIMING_USER_1600X900_60_RB;
            break;
        case HI_DRV_DISP_FMT_VESA_1920X1080_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_USER_1920X1080_60;
            break;
        case HI_DRV_DISP_FMT_VESA_2048X1152_60:
            VideoTimingMode = HDMI_VIDEO_TIMING_USER_2048X1152_60;
            break;
        case HI_DRV_DISP_FMT_VESA_2560X1440_60_RB:
            VideoTimingMode = HDMI_VIDEO_TIMING_USER_2560X1440_30;
            break;
        default:
...
static HI_S32 Hdmi_InfoFrameUser2Drv(DRV_HDMI_INFOFRAME_S *pstDestInfoFrame, HI_UNF_HDMI_INFOFRAME_S *pstSrcInfoFrame)
{
    ...
    switch (pstSrcInfoFrame->enInfoFrameType)
    {
        case HI_INFOFRAME_TYPE_AVI:
        {
            ...
            switch(pstUnfAVIInfoFrame->enScanInfo)
            {
                case HDMI_SCAN_INFO_NO_DATA:
                    pstDrvAVIInfoFrame->scan_mode = HDMI_SCAN_MODE_NONE;
                    break;
                case HDMI_SCAN_INFO_OVERSCANNED:
                    pstDrvAVIInfoFrame->scan_mode = HDMI_SCAN_MODE_OVERSCAN;
                    break;
                case HDMI_SCAN_INFO_UNDERSCANNED:
                    pstDrvAVIInfoFrame->scan_mode = HDMI_SCAN_MODE_UNDERSCAN;
                    break;
                case HDMI_SCAN_INFO_FUTURE:
                    pstDrvAVIInfoFrame->scan_mode = HDMI_SCAN_MODE_FUTURE;
                    break;
                default:
                    break;
            }

            switch(pstUnfAVIInfoFrame->enAspectRatio)
            {
                case HI_UNF_HDMI_ASPECT_RATIO_NO_DATA:
                    pstDrvAVIInfoFrame->picture_aspect = HDMI_PICTURE_ASPECT_NONE;
                    break;

                case HI_UNF_HDMI_ASPECT_RATIO_4TO3:
                    pstDrvAVIInfoFrame->picture_aspect = HDMI_PICTURE_ASPECT_4_3;
                    break;

                case HI_UNF_HDMI_ASPECT_RATIO_16TO9:
                    pstDrvAVIInfoFrame->picture_aspect = HDMI_PICTURE_ASPECT_16_9;
                    break;
                case HI_UNF_HDMI_ASPECT_RATIO_64TO27:
                    pstDrvAVIInfoFrame->picture_aspect = HDMI_PICTURE_ASPECT_64_27;
                    break;
                case HI_UNF_HDMI_ASPECT_RATIO_256TO135:
                    pstDrvAVIInfoFrame->picture_aspect = HDMI_PICTURE_ASPECT_256_135;
                    break;
                case HI_UNF_HDMI_ASPECT_RATIO_FUTURE:
                    pstDrvAVIInfoFrame->picture_aspect = HDMI_PICTURE_ASPECT_FUTURE;
                    break;

                case HI_UNF_HDMI_ASPECT_RATIO_BUTT:
                default:
                    pstDrvAVIInfoFrame->picture_aspect = HDMI_PICTURE_ASPECT_BUTT;
                    break;
            }

            /* !!UNF enActiveAspectRatio type defined is  not proper,so the conver is not accurate. */
            switch(pstUnfAVIInfoFrame->enActiveAspectRatio)
            {
                case HI_UNF_HDMI_ASPECT_RATIO_NO_DATA :
                    pstUnfAVIInfoFrame->enActiveAspectRatio = HDMI_ACTIVE_ASPECT_PICTURE;
                    break;

                case HI_UNF_HDMI_ASPECT_RATIO_4TO3:
                    pstUnfAVIInfoFrame->enActiveAspectRatio = HDMI_ACTIVE_ASPECT_4_3;
                    break;

                case HI_UNF_HDMI_ASPECT_RATIO_16TO9:
                    pstUnfAVIInfoFrame->enActiveAspectRatio = HDMI_ACTIVE_ASPECT_16_9;
                    break;
                case HI_UNF_HDMI_ASPECT_RATIO_64TO27:
                    pstUnfAVIInfoFrame->enActiveAspectRatio = HDMI_PICTURE_ASPECT_64_27;
                    break;
                case HI_UNF_HDMI_ASPECT_RATIO_256TO135:
                    pstUnfAVIInfoFrame->enActiveAspectRatio = HDMI_PICTURE_ASPECT_256_135;
                    break;
                case HI_UNF_HDMI_ASPECT_RATIO_FUTURE:
                default:
                    pstUnfAVIInfoFrame->enActiveAspectRatio = HDMI_ACTIVE_ASPECT_14_9;
                    break;
