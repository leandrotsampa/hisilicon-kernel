...
static HI_S32 VDEC_VPSSCMD(HI_HANDLE hVdec, VPSS_CMD_E enCMD, HI_VOID* pstParam)
{
    ...
    /*vpss�Ĵ�������HI_MPI_VDEC_SetChanAttr������ִ�е�,���ڴ�����ʱ��vpss���������pstVdec->hVpss��*/
    /*��vdecͨ���ϴ���port��Ӧ����ͨ��vdec����ҵ����vdec��Ӧ��vpss���*/
    ...
    while (!pstVdec->bThreadStop)
    {
        ...
        if (!bGetFrameBuf)
        {
            ...
            if (HI_SUCCESS == s32Ret)
            {
                ...
                VDEC_GetBufferVirAddr(pstVdec->hFrameBuf,stFrmGet.u32PhyAddr,&pVirAddr);
        ...
        if (2 != pstVdec->u32EosFlag)   /* If not end of stream */
        {
            ...
            else
            {
                if (HI_INVALID_HANDLE != pstVdec->hStreamBuf)
                {
                    ...
                    {
                        /* Make stCodecStrm */
                        stCodecStrm.pu8Addr = (HI_U8*)stStrm.pu8Addr;
                ...
                else if (HI_INVALID_HANDLE != pstVdec->hDmxVidChn)
                {
                    for (i = 0; i < u32Count; i++)
                    {
                        ...
                        {
                            /* Make stCodecStrm */
                            stCodecStrm.pu8Addr = (HI_U8*)stDmxBuf.pu8Buf;
...
//add by l00228308,for vpss bypass ,overlay will release frame buffer after vdec & vfmw instance destory
