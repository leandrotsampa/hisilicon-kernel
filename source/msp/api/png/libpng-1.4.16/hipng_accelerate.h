...
#define HIPNG_ARGB1555 0x4000000L   /*Output format is ARGB1555*/
#define HIPNG_ARGB4444 0x10000000L	/*Output format is ARGB4444*/
#define HIPNG_RGB565 0x20000000L	/*Output format is RGB565*/
#define HIPNG_RGB555 0x40000000L	/*Output format is RGB555*/
#define HIPNG_RGB444 0x80000000L	/*Output format is RGB444*/
