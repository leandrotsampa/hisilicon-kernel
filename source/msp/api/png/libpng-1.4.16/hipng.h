...
PNG_EXPORT(void, png_set_outfmt) PNGARG((png_structp png_ptr, HIPNG_FMT_E eOutFmt));

PNG_EXPORT(void, png_set_swdec) PNGARG((png_structp png_ptr));

PNG_EXPORT(void, png_get_state) PNGARG((png_structp png_ptr, PNG_BOOL bBlock,PNG_STATE_E *pState));

PNG_EXPORT(void, png_set_inflexion) PNGARG((png_structp png_ptr, 
    png_uint_32 u32InflexionSize));


PNG_EXPORT(void, png_read_image_async) PNGARG((png_structp png_ptr, 
    png_bytepp image));


PNG_EXPORT(void, png_read_png_async) PNGARG((png_structp png_ptr,
                        png_infop info_ptr,
                        int transforms,
                        png_voidp params));


PNG_EXPORT(void,png_set_premulti_alpha) PNGARG((png_structp png_ptr));
