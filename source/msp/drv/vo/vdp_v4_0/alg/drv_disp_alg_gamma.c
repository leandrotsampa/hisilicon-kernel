...
static HI_U16 u16TmpRGB[960*4] = {0};//0~959;960~1919;1920~2879;2880~3839	//Too large,	��ջ���stack overflow, so make it static ȫ�ֱ���

//now it is just one mode
static HI_U32 GmmTransCoefAlign(const HI_U16* pu16GmmCoef, GMM_COEF_BITARRAY_S* pBitCoef)
{
    HI_U32  i, j, u32Cnt, u32Tmp, u32Mode, u32OriNum;
    HI_U16* pu16GmmCoef0;
    HI_U16* pu16GmmCoef1;
    HI_U16* pu16GmmCoef2;
    HI_U32 k = 0;
