...
typedef SINT32	 (*FN_OSAL_SpinLockInit)(SpinLockType);
...
typedef SINT32 (*FN_OSAL_KernelMemAlloc)(CHAR *memName, UINT32 length, UINT32 align, UINT32 isCached, MEM_DESC_S *pMemDesc);
...
typedef SINT32 (*FN_OSAL_CreateTask)(VOID *pParam, CHAR *taskName, VOID *pTaskFunc);
...
#define OSAL_FP_mem_alloc		      vfmw_Osal_Func_Ptr_S.pfun_Osal_KernelMemAlloc
#define OSAL_FP_mem_free		      vfmw_Osal_Func_Ptr_S.pfun_Osal_KernelMemFree
