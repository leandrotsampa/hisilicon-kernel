...
#define	 VDEC_ERR_ALREADY_INIT	-9
#define	 VDEC_ERR_NULL_PRT	-10
...
typedef enum
{
    DV_SINGLE_VES_IMP,	       /**<single VES implementation 单流*/
    DV_DUAL_VES_IMP,	       /**<dual VES implementation 双流*/
    DV_MAX_VES_IMP
} DV_VES_IMP_E_;
...
{
    VDEC_CID_GET_CAPABILITY	      = 0,			 /* get the capacity of the decoder */
    VDEC_CID_CREATE_CHAN	      = 1,			    /* create channel */
    VDEC_CID_DESTROY_CHAN	      = 2,			   /* destroy channel */
    VDEC_CID_GET_CHAN_CFG	      = 3,			   /* get the configuration of the decode channel */
    VDEC_CID_CFG_CHAN		      = 4,			       /* config the decode channel */
    VDEC_CID_GET_CHAN_STATE	      = 5,			 /* get the state of the decode channel */
    VDEC_CID_START_CHAN		      = 6,			     /* start channel */
    VDEC_CID_STOP_CHAN		      = 7,			      /* stop channel */
    VDEC_CID_RESET_CHAN		      = 8,			     /* reset channel */
    VDEC_CID_SET_STREAM_INTF	      = 9,			/* set the stream access interface for the decode channel */
    VDEC_CID_GET_STREAM_SIZE	      = 10,			 /* get the stream size(in byte) held by vfmw */
    VDEC_CID_GET_CHAN_MEMSIZE	      = 11,			/* get the memory budget for the specified channel capacity level */
    VDEC_CID_GET_CHAN_ID_BY_MEM	      = 12,		      /* querry the channel number according the memroy physical address */
    VDEC_CID_RELEASE_STREAM	      = 13,			  /* reset scd to release stream buffers */
    VDEC_CID_RESET_CHAN_WITH_OPTION   = 14,		  /* reset channel with options to keep some characters of the channel */
    VDEC_CID_SET_FRAME_INTF	      = 15,			  /* bvt set get frame interface */
    VDEC_CID_GET_USRDEC_FRAME	      = 16,			/* for VFMW_USER channel, get a frame block from vfmw */
    VDEC_CID_PUT_USRDEC_FRAME	      = 17,			/* for VFMW_USER channel, push a frame(info) into vfmw */
    VDEC_CID_SET_DISCARDPICS_PARAM    = 18,		   /* get discard pictures parameters*/
    VDEC_CID_EXTRA_WAKEUP_THREAD      = 19,		     /* bvt set wake up vfmw thread */
    VDEC_CID_SET_DBG_OPTION	      = 20,			  /* set debug options */
    VDEC_CID_SET_PTS_TO_SEEK	      = 21,			 /* set pts to be seeked by vfmw */
    VDEC_CID_SET_TRICK_MODE	      = 22,			  /* set fast forward or backword speed */
    VDEC_CID_SET_CTRL_INFO	      = 23,			  /* set pvr fast forward or backword stream info and control info*/
    VDEC_CID_SET_FRAME_RATE	      = 24,
    VDEC_CID_START_LOWDLAY_CALC	      = 25,
    VDEC_CID_STOP_LOWDLAY_CALC	      = 26,
    VDEC_CID_ALLOC_MEM_TO_CHANNEL     = 27,
    VDEC_CID_ALLOC_MEM_TO_DECODER     = 28,
    VDEC_CID_SET_FRAME_BUFFER_NUM     = 29,
    VDEC_CID_GET_OUTPUT_FORMAT	      = 30,
    VDEC_CID_REPORT_DEMUX_RELEASE     = 31,
    VDEC_CID_SET_FRAME_RATE_TYPE      = 32,
    VDEC_CID_GET_FRAME_RATE_TYPE      = 33,

#ifdef VFMW_VPSS_BYPASS_EN
    VDEC_CID_SET_IMG_OUTPUT_INFO      = 34,
    VDEC_CID_REPORT_OCCUQIED_FRM      = 35,
#endif
...
typedef struct hiSTREAM_PACKET_S
{
    ...
    UINT8	is_stream_end_flag;	   //add by  2012.12.10
...
{
    DRV_VDEC_BUFFER_STATUS_PREALLOC = 0,
    DRV_VDEC_BUFFER_STATUS_SYSALLOC,
    DRV_VDEC_BUFFER_STATUS_BUTT = 0xFF
} BUFFER_NODE_STATUS;
...
typedef struct
{
    VDEC_CHAN_CAP_LEVEL_E   CapToFmw;
    VDEC_CHAN_OPTION_S	    Option;
} VDEC_CHAN_CREATE_OPTION_S;
