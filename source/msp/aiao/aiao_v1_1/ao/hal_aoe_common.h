...
typedef enum
{
    AOE_AIP_STATUS_STOP = 0, /**<Stop*//**<CNcomment: ֹͣ */
    AOE_AIP_STATUS_START, /**<Start*//**<CNcomment: ���� */
...
typedef enum
{
    AOE_AOP_STATUS_STOP = 0, /**<Stop*//**<CNcomment: ֹͣ */
    AOE_AOP_STATUS_START, /**<Start*//**<CNcomment: ���� */
...
typedef enum
{
    AOE_ENGINE_STATUS_STOP = 0, /**<Stop*//**<CNcomment: ֹͣ */
    AOE_ENGINE_STATUS_START, /**<Start*//**<CNcomment: ���� */
...
typedef struct
{
    ...
    HI_U32 u32BufChannels; /**<I/O, number of channels*//**<CNcomment:OUT. ���������  */
    HI_U32 u32BufSampleRate; /**<I/O, sampling rate*//**<CNcomment:OUT. �������Ƶ�� */
...
typedef struct
{
    ...
    HI_U32 u32FifoChannels; /**<I/O, number of channels*/ /**<CNcomment:OUT. ���������	 */
    HI_U32 u32FifoSampleRate; /**<I/O, sampling rate*/ /**<CNcomment:OUT. �������Ƶ�� */
...
typedef struct
{
    ...
    HI_U32 u32Channels; /**<I/O, number of channels*/ /**<CNcomment:OUT. ���������  */
    HI_U32 u32SampleRate; /**<I/O, sampling rate*/ /**<CNcomment:OUT. �������Ƶ�� */
